...
def startMongoServer(host='localhost', port=45017, options=None,
    ...
    if not 'bin' in os.listdir(sandbox):
        ...
        # windows
            ...
            url = 'https://fastdl.mongodb.org/win32/mongodb-win32-x86_64-%s.zip' % version
        elif os.name == 'nt' and arch == '32bit':
            url = 'https://fastdl.mongodb.org/win32/mongodb-win32-i386-%s.zip' % version
        # mac
        elif sys.platform == 'darwin' (force64bit or arch == '64bit'):
            url = 'https://fastdl.mongodb.org/osx/mongodb-osx-x86_64-%s.tgz' % version
        elif sys.platform == 'darwin' and arch == '32bit':
            url = 'https://fastdl.mongodb.org/osx/mongodb-osx-i386-%s.tgz' % version
        # posix
        elif os.name == 'posix' and (force64bit or arch == '64bit'):
            url = 'https://fastdl.mongodb.org/linux/mongodb-linux-x86_64-%s.tgz' % version
        elif os.name == 'posix' and arch == '32bit':
            url = 'https://fastdl.mongodb.org/linux/mongodb-linux-i686-%s.tgz' % version
        else:
