    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug_en', models.SlugField(null=True, verbose_name='slug', blank=True)),
                ('slug_de', models.SlugField(null=True, verbose_name='slug', blank=True)),
                ('slug_fr', models.SlugField(null=True, verbose_name='slug', blank=True)),
