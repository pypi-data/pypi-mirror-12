...
class TestXMLCompare(unittest.TestCase):
  def test_correct_compare_with_itself(self):
    ...
    d1_common.xml_compare.compare(StringIO.StringIO(xml_correct), StringIO.StringIO(xml_correct))

  def test_correct_swapped_attributes(self):
    '''Compare xml_correct with itself and verify that compare passes.'''
    d1_common.xml_compare.compare(StringIO.StringIO(xml_correct), StringIO.StringIO(xml_correct_swapped_attributes))

  def test_error_missing_count(self):
    '''Verify that comparison fails when an attribute is missing.'''
    self.assertRaises(d1_common.xml_compare.CompareError,
                      d1_common.xml_compare.compare,
                      StringIO.StringIO(xml_correct),
                      StringIO.StringIO(xml_missing_count))
  ...
  def test_error_missing_entry(self):
    ...
    self.assertRaises(d1_common.xml_compare.CompareError,
                      d1_common.xml_compare.compare,
                      StringIO.StringIO(xml_correct),
                      StringIO.StringIO(xml_missing_entry))
  ...
  def test_error_wrong_order(self):
    ...
    self.assertRaises(d1_common.xml_compare.CompareError,
                      d1_common.xml_compare.compare,
                      StringIO.StringIO(xml_correct),
                      StringIO.StringIO(xml_wrong_order))
  ...
  def test_error_missing_text(self):
    ...
    self.assertRaises(d1_common.xml_compare.CompareError,
                      d1_common.xml_compare.compare,
                      StringIO.StringIO(xml_correct),
                      StringIO.StringIO(xml_missing_text))
  ...
  def test_error_xml_syntax_error(self):
    ...
    self.assertRaises(d1_common.xml_compare.CompareError,
                      d1_common.xml_compare.compare,
                      StringIO.StringIO(xml_correct),
                      StringIO.StringIO(xml_syntax_error))
