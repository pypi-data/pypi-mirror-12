...
class TestExceptions(unittest.TestCase):
  ...
  def test_250(self):
    ...
    self.assertEqual(e.serialize(), '<?xml version="1.0" ?><error detailCode="123" errorCode="500" name="ServiceFailure"/>')


  def test_260(self):
    '''create with string detailCode and description, then serialize()'''
    e = exceptions.ServiceFailure('123.456.789', 'test description')
    self.assertEqual(e.serialize(), u'<?xml version="1.0" ?><error detailCode="123.456.789" errorCode="500" name="ServiceFailure"><description>test description</description></error>')
  ...
  def test_270(self):
    ...
    self.assertEqual(e.serialize(), u'<?xml version="1.0" ?><error detailCode="123.456.789" errorCode="500" name="ServiceFailure"><description>test description</description><traceInformation><value>test traceInformation</value></traceInformation></error>')
