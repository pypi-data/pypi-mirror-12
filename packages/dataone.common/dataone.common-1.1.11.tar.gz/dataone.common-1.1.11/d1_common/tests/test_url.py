...
class TestUrl(unittest.TestCase):
  ...
  def test_070(self):
    ...
    self.assertEqual(d1_common.url.makeCNBaseURL('test.com/a/cn'), 'https://test.com/a/cn')
    ...
    self.assertEqual(d1_common.url.makeCNBaseURL('http://test.com/cn'), 'http://test.com/cn')
    self.assertEqual(d1_common.url.makeCNBaseURL('http://test.com/a/b/c/cn'), 'http://test.com/a/b/c/cn')
  ...
  def test_080(self):
    ...
    self.assertEqual(d1_common.url.makeMNBaseURL('test.com/a/mn'), 'https://test.com/a/mn')
    ...
    self.assertEqual(d1_common.url.makeMNBaseURL('http://test.com/mn'), 'http://test.com/mn')
    self.assertEqual(d1_common.url.makeMNBaseURL('http://test.com/a/b/c/mn'), 'http://test.com/a/b/c/mn')
