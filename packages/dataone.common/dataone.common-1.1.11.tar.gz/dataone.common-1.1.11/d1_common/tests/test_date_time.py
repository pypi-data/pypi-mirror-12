...
class TestDateTime(unittest.TestCase):
  ...
  def test_010(self):
    ...
    self.assertEqual(d1_common.date_time.to_seconds_since_epoch(dt),
                     921805323)
  ...
  def _from_http_datetime(self, that_fateful_day_in_november_94):
    ...
    self.assertEqual(dt, d1_common.date_time.create_utc_datetime(
      1994, 11, 6, 8, 49, 37))
  ...
  def test_420(self):
    ...
    dt = self._test_date_YEKT()
    self.assertRaises(TypeError, d1_common.date_time.normalize_datetime_to_utc, dt, 3 * 60)
