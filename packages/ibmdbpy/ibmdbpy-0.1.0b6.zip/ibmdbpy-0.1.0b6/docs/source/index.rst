...
The result fetched by ibmdbpy is a tuple containing all values of the matrix, which is formatted back in a Pandas.DataFrame and finally returned::
...
Ibmdbpy can do much more than that. More information is available in this documentation for you. Enjoy!
