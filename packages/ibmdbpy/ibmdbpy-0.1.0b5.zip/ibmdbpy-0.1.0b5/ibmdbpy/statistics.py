...
def _categorical_stats(idadf, stat, columns):
    # TODO:
    """
    Compute various stats from one or several categorical columns of the IdaDataFrame.
    NOTIMPLEMENTED.
...
def _count_level(idadf, columnlist=None):
    """
    Compute the count of dictinct levels accross a list of columns of an
...
def _count_level_groupby(idadf, columnlist=None):
    """
    Compute the count of dictinct levels accross a list of columns in the
...
def _factors_count(idadf, columnlist, valuelist=None):
    """
    Compute the count of non missing values for all columns in a list
...
def _factors_avg(idadf, columnlist, valuelist):
    """
    Compute the arithmetic average for all columns in a list (valuelist)
    over the IdaDataFrame grouped by a list of columns (columnlist).
