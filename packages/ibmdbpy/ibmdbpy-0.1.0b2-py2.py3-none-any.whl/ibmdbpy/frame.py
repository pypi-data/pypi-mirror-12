...
class IdaDataFrame(object):
    ...
    def __init__(self, idadb, tablename, indexer = None):
        ...
        ----------
        idadb : IdaDataBase
            ida_database object which contains the connection to be used.
        tablename : str
            Name of the table to be opened in the database.
        indexer : str, optional
            Name of the column that should be used as an index. This is
            optional. However, if not indexer was given, the real order of
        ...
        name : str
            Name of the table the instance is referencing.
        schema : str
...
###############################################################################
    ...
    def internal_state(self):
        """
        InternalState objects are responsible for managing the state of an
    ...
    def indexer(self):
        ...
        guaranteed as far as the dataset is not sorted.
        """
    ...
    def __add__(self, other):
        ...
        Notes
        -----
        Arithmetic operations make sense is self has only numeric columns.
        """
    ...
    def __neg__(self):
        """
        Performs the absolute negative of all columns self
...
#            data = ibmdbpy.utils._convert_dtypes(self, data)
    ...
    def pivot_table(self, values=None, columns=None, max_entries=1000,
        ...
        values: str or list or str optional
            List of columns on which "aggfunc" is to be computed.
...
###############################################################################
    ...
    def quantile(self, q=0.5):
        ...
        quantiles: Series or DataFrame
            ...
            columns are the columns of self, and the values are the
