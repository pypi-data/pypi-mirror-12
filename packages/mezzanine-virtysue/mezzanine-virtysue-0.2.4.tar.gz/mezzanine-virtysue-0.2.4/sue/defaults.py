...
register_setting(
    ...
    editable=False,
    default=("THEME_SKINS", "SEARCH_CONSOLE", "PAYFAST_MERCHANT_ID", "PAYFAST_MERCHANT_KEY",),
    append=True,
)
...
register_setting(
    ...
    label=_("PayFast Merchant ID"),
    description=_("Merchant Id for PAYFAST payment gateway"),
    editable=True,
    default="",
)
...
register_setting(
    ...
    label=_("PayFast Merchant Key"),
    description=_("Merchant Key for PAYFAST payment gateway"),
    editable=True,
    default="",
)
