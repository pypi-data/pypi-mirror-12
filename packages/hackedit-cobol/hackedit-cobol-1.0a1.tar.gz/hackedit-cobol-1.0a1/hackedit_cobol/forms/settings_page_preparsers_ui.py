...
# Form implementation generated from reading ui file '/home/colin/Documents/hackedit_cobol/data/forms/settings_page_preparsers.ui'
#
...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.groupBox.setTitle(_translate("Form", "Preparsers"))
        self.combo_configs.setToolTip(_translate("Form", "The list of COBOL preparsers configurations"))
        self.bt_add_cfg.setToolTip(_translate("Form", "Add new preparser configuration."))
        self.bt_add_cfg.setText(_translate("Form", "..."))
        self.bt_rm_cfg.setToolTip(_translate("Form", "Remove preparser configuration."))
        self.bt_rm_cfg.setText(_translate("Form", "..."))
        self.group_config.setTitle(_translate("Form", "Configuration"))
        self.label_2.setText(_translate("Form", "Associated extensions:"))
        self.edit_extensions.setToolTip(_translate("Form", "<html><head/><body><p>The list of extension associated with the preparser.</p></body></html>"))
        self.label_3.setText(_translate("Form", "Parser path:"))
        self.edit_parser_path.setToolTip(_translate("Form", "Path to the parser executable."))
        self.bt_parser_path.setToolTip(_translate("Form", "Select parser path."))
        self.bt_parser_path.setText(_translate("Form", "..."))
        self.label_4.setText(_translate("Form", "Parser flags:"))
        self.edit_parser_flags.setToolTip(_translate("Form", "Set the parser flags"))
        self.label_output_rule.setText(_translate("Form", "Parser output rule:"))
        self.edit_output_rule.setToolTip(_translate("Form", "<html><head/><body><p>This rule determines the output file path of the preparser (relative to the source file or absolute). </p><p>If &quot;Only preparser&quot; is checked, the output rule specify the path to the final executable that can be run by the IDE (e.g. build/$file.exe). </p><p>If it is not checked, the output rule specify the path to the generated COBOL source file that will be compiled using the project compiler configuration (and the aditional COBOL compiler flags).</p><p>You can use &quot;$file&quot; to refer to the source file name (without extension).</p></body></html>"))
        self.edit_output_rule.setText(_translate("Form", "$file.cob"))
        self.cb_only_preparser.setToolTip(_translate("Form", "Check in case your preparser already produces an executable."))
        self.cb_only_preparser.setText(_translate("Form", "Only preparser"))
        self.label_cobol.setText(_translate("Form", "Extra COBOL Compiler flags:"))
        self.edit_cobol_compiler_flags.setToolTip(_translate("Form", "The list of extra compiler flags to set for compiling the cobol output file."))
