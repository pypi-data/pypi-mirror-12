...
# Form implementation generated from reading ui file '/home/colin/Documents/hackedit_cobol/data/forms/dlg_dbpre.ui'
#
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "DBPRE Configuration"))
        self.label.setText(_translate("Dialog", "Executable:"))
        self.edit_exe.setToolTip(_translate("Dialog", "Path to the dbpre executable"))
        self.bt_exe.setToolTip(_translate("Dialog", "Choose the directory that contains the dbpre executable."))
        self.bt_exe.setText(_translate("Dialog", "..."))
        self.label_2.setText(_translate("Dialog", "cobmysqlapi.o:"))
        self.edit_obj.setToolTip(_translate("Dialog", "Path to cobmysqlapi.o"))
        self.bt_obj.setToolTip(_translate("Dialog", "Choose the directory that contains cobmysqlapi.o"))
        self.bt_obj.setText(_translate("Dialog", "..."))
        self.label_3.setText(_translate("Dialog", "Copybooks:"))
        self.edit_copy.setToolTip(_translate("Dialog", "<html><head/><body><p>Path to the directory that contains the dbpre copybooks.</p></body></html>"))
        self.bt_copy.setToolTip(_translate("Dialog", "Choose the directory that contains the dbpre copybooks"))
        self.bt_copy.setText(_translate("Dialog", "..."))
