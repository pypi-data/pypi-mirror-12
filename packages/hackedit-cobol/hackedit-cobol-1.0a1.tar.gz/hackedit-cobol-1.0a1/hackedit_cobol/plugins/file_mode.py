...
class CobFileManager(CobolManagerPluginBase):
    ...
    def configure(self):
        ...
        ret_val = DlgConfigureFile.configure(path, self._window)
        if ret_val:
            ...
            try:
                ...
                if include_submodules:
                    submodules = get_submodules(
                        fpath, recursive=True, free_format=fcfg['free-format'])
...
class DlgConfigureFile(DlgConfigureBase):
    ...
    @classmethod
    def configure(cls, fpath, parent):
        """
