...
__doc__ = '''Common Directive definitions'''
...
class FS(directive.Directive):
    ...
    def __init__(self, toklist):
        ...
        super(FS, self).__init__(toklist)
...
class PID(directive.Directive):
    ...
    def __init__(self, toklist):
        ...
        super(PID, self).__init__(toklist)
...
class PROC(directive.Directive):
    ...
    def __init__(self, toklist):
        ...
        super(PROC, self).__init__(toklist)
...
class SP(directive.Directive):
    ...
    def __init__(self, toklist):
        ...
        super(SP, self).__init__(toklist)
...
class COM(directive.Directive):
    ...
    def __init__(self, toklist):
        super(COM, self).__init__(toklist)
...
class IF(directive.Directive):
    ...
    def __init__(self, toklist):
        ...
        super(IF, self).__init__(toklist)
...
class NET(directive.Directive):
    ...
    def __init__(self, toklist):
        ...
        super(NET, self).__Init__(toklist)
    ...
    def tokenparser(self, toklist, toktypes, indent):
        ...
        super(NET, self).tokenparser(toklist, toktypes, indent)
        ...
        log.log("<directive>NET.tokenparser(): ID '%s' rule '%s'" %
...
class SYS(directive.Directive):
    ...
    def __init__(self, toklist):
        ...
        super(SYS, self).__init__(toklist)

    def tokenparser(self, toklist, toktypes, indent):
        """Parse rest of rule (after ':')."""
        super(SYS, self).tokenparser(toklist, toktypes, indent)
        ...
        log.log("<directive>SYS.tokenparser(): ID '%s' rule '%s'" %
                (self.state.ID, self.args.rule), 8)
...
class STORE(directive.Directive):
    ...
    def __init__(self, toklist):
        self.need_collectors = (
            ...
            ('netstat', 'stats_ctrs'),
            ('proc', 'procList'))
        super(STORE, self).__init__(self, toklist)
