...
class FormField(object):
    ...
    def __set__(self, instance, value):
        ...
        try:
            ...
            instance.errors[self.name] = e.message
            value = UNSET
...
class Form(with_metaclass(FormMeta, object)):
    ...
    def __init__(self, **data):
        ...
        using :py:attr:`.data` attribute
        """
        self.raw_data = {}  # create a container for Form data
    ...
    def data(self):
        ...
        .. deprecated:: 0.3.0
            Will be removed in v1.0.0. Use :py:meth:`.Form.to_python()` instead

        Returns :code:`dict` with bound data (if you need all data even :py:data:`.UNSET` values -
        use :py:attr:`.raw_data`)
        """
