...
class Sensor(Endpoint):
    def __init__(self, settings, sensor_id, project_id=None, device_id=None):
        """
        ...
        self.api_endpoint += "/project/" + str(self.project_id) + "/device/" + str(device_id) + "/sensor/" + str(self.endpoint_id) + "/"
        self.headers = {
            'Content-type': 'application/x-www-form-urlencoded',
            'X-ApiKey':     self.settings['api_key']
        }
    ...
    def set(self, value, method=POST_URLENCODED):
        ...
        resp, content = self.h.request(self.api_endpoint, "POST", data, self.headers)
