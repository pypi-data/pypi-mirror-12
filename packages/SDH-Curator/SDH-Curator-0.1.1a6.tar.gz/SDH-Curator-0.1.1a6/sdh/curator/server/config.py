...
def _redis_conf(def_host, def_db, def_port):
    return {'host': os.environ.get('REDIS_HOST', def_host),
            'db': os.environ.get('REDIS_DB', def_db),
            'port': os.environ.get('REDIS_PORT', def_port)}
...
def _rabbit_conf(def_host, def_port):
    return {'host': os.environ.get('RABBIT_HOST', def_host),
            'port': os.environ.get('RABBIT_PORT', def_port)}
