...
class TestRetailersGlobals(RetailersTestCase):
    ...
    def test_retailers_globals_services(self):
        ...
        httpretty.register_uri(httpretty.POST, response_400, '', status=400)
        httpretty.register_uri(httpretty.POST, response_404, '', status=404)
        ...
        httpretty.register_uri(httpretty.GET, response_400, '', status=400)
        httpretty.register_uri(httpretty.GET, response_404, '', status=404)
        httpretty.register_uri(httpretty.GET, response_500, '', status=500)

        # PUT
        httpretty.register_uri(httpretty.PUT, response_200, '', status=200)
        httpretty.register_uri(httpretty.PUT, response_400, '', status=400)
        httpretty.register_uri(httpretty.PUT, response_404, '', status=404)
