    ...
    def start_server(self):
        ...
        with self.lock:
            ...
            if self.serverConfig.is_minorating_activated():
                ...
                if os.name == 'posix':
                    # prepend mono
                    minorating_executable_path = "mono " + minorating_executable_path

                with open(os.devnull, 'w') as dnull:
                    mr_process = subprocess.Popen([minorating_executable_path], cwd=mr_dir_path, stderr=dnull, stdout=dnull)
