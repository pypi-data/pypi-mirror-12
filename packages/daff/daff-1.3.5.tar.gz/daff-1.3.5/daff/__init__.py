	...
	def show(t):
		...
		while ((_g < h)):
			...
			while ((_g1 < w)):
				...
				txt = (HxOverrides.stringOrNull(txt) + " ")
			txt = (HxOverrides.stringOrNull(txt) + "\n")
		haxe_Log.trace(txt,_hx_AnonObject({'fileName': "Coopy.hx", 'lineNumber': 968, 'className': "Coopy", 'methodName': "show"}))
...
Coopy = _hx_classes.registerClass("Coopy", fields=["format_preference","delim_preference","extern_preference","output_format","output_format_set","nested_output","order_set","order_preference","io","pretty","strategy","css_output","fragment","flags","mv","status","daff_cmd"], methods=["init","checkFormat","setFormat","renderTable","saveTable","encodeTable","saveTables","saveText","loadTable","command","installGitDriver","coopyhx"], statics=["VERSION","diffAsHtml","diffAsAnsi","diff","patch","compareTables","compareTables3","keepAround","cellFor","jsonToTable","main","show","jsonify","tablify"])(Coopy)
