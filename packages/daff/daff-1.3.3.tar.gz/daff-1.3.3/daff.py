...
CombinedTable = _hx_classes.registerClass("CombinedTable", fields=["t","body","head","dx","dy","core","meta"], methods=["all","getTable","get_width","get_height","getCell","setCell","toString","getCellView","isResizable","resize","clear","insertOrDeleteRows","insertOrDeleteColumns","trimBlank","getData","clone","getMeta"], interfaces=[Table])(CombinedTable)
...
CombinedTableBody = _hx_classes.registerClass("CombinedTableBody", fields=["parent","dx","dy","all","meta"], methods=["getTable","get_width","get_height","getCell","setCell","toString","getCellView","isResizable","resize","clear","insertOrDeleteRows","insertOrDeleteColumns","trimBlank","getData","clone","getMeta"], interfaces=[Table])(CombinedTableBody)
...
CombinedTableHead = _hx_classes.registerClass("CombinedTableHead", fields=["parent","dx","dy","all"], methods=["getTable","get_width","get_height","getCell","setCell","toString","getCellView","isResizable","resize","clear","insertOrDeleteRows","insertOrDeleteColumns","trimBlank","getData","clone","getMeta"], interfaces=[Table])(CombinedTableHead)
...
class Coopy(object):
	...
	def coopyhx(self,io):
		...
		if (cmd1 == "git"):
			...
			if (pos24 < 0):
				pos24 = 0
			res24 = args[pos24:(pos24 + len)]
			del args[pos24:(pos24 + len)]
			types = res24
		...
		if git:
			...
			if (pos25 < 0):
				pos25 = 0
			res25 = args[pos25:(pos25 + ct)]
			del args[pos25:(pos25 + ct)]
			git_args = res25
			...
			if (pos26 < 0):
				pos26 = 0
			res26 = args[pos26:(pos26 + len1)]
			del args[pos26:(pos26 + len1)]
			res26
			offset = 0
	...
	def show(t):
		...
		while ((_g < h)):
			...
			while ((_g1 < w)):
				...
				txt = (HxOverrides.stringOrNull(txt) + " ")
			txt = (HxOverrides.stringOrNull(txt) + "\n")
		haxe_Log.trace(txt,_hx_AnonObject({'fileName': "Coopy.hx", 'lineNumber': 965, 'className': "Coopy", 'methodName': "show"}))
...
Coopy = _hx_classes.registerClass("Coopy", fields=["format_preference","delim_preference","extern_preference","output_format","output_format_set","nested_output","order_set","order_preference","io","pretty","strategy","css_output","fragment","flags","mv","status","daff_cmd"], methods=["init","checkFormat","setFormat","renderTable","saveTable","encodeTable","saveTables","saveText","loadTable","command","installGitDriver","coopyhx"], statics=["VERSION","diffAsHtml","diffAsAnsi","diff","patch","compareTables","compareTables3","keepAround","cellFor","jsonToTable","main","show","jsonify"])(Coopy)
...
SqlTables = _hx_classes.registerClass("SqlTables", fields=["db","t","flags"], methods=["getCell","setCell","getCellView","isResizable","resize","clear","insertOrDeleteRows","insertOrDeleteColumns","trimBlank","get_width","get_height","getData","clone","getMeta"], interfaces=[Table])(SqlTables)
...
class TableDiff(object):
	...
	def hiliteWithNesting(self,output):
		...
		while ((_g < python_lib_Builtin.len(order))):
			...
			result = (result and td.hilite(child_output))
		return result
