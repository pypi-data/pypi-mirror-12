...
class AppBuilder():
    ...
    def load_cfg(self):
        ...
        if self.cfg_mode == 'json':
            with open(self.cfg_file) as opened_file:
                self.cfg = json.load(opened_file)
        else:
    ...
    def save_cfg(self):
        ...
        if self.cfg_mode == 'json':
            with open(self.cfg_file, 'w') as opened_file:
                json.dump(self.cfg, opened_file)
        else:
            with open(self.cfg_file, 'w')as opened_file:
                yaml.dump(self.cfg, opened_file)
