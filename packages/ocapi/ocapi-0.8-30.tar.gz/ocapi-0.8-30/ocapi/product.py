...
class CabinetMakerBase(object):
    ...
    def add_frame(self, area_id=None,diff=None,diff_fill=[0, 0, 5, 0, 0, 0],diff_frame=None,edge_fill=None,edge_frame=None,info=None,insert_fill=True,low_profile=True,mat=None,mat_fill=None,order=[0, 1, 2, 3],planes=None,post_diff=None,rotate_fill_diff=False,rotate_frame_diff=False,save=True,thick=None,thick_fill=None,width=None):
        '''
        :param area_id: id of area 0 or 2 or ``[1,2,3]`` to apply on multiple areas
        :type area_id: int or list
        :param diff: differences in axis ``[X left, X right, Y front, Y back, Z bottom, Z top]``
