...
def get_total_product_developers(prid, **kwargs):
    return aggregate(store, 'metrics:total-product-developers:{}'.format(prid), kwargs['begin'], kwargs['end'],
                     kwargs['max'])
...
def get_total_project_developers(prid, **kwargs):
    return aggregate(store, 'metrics:total-project-developers:{}'.format(prid), kwargs['begin'], kwargs['end'],
                     kwargs['max'])
