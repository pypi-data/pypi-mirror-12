"""Contains the DataAccessCore base class, and some helpers related to it."""
from . import SQLWriter
...
class DataAccessCoreBase(object):
  ...
  def open(self):
    """Open a connection. Must be overridden."""
    raise NotImplementedError()

  def close(self, connection, commit=True):
    """Close a connection, commiting pending changes if commit is True. Must be overridden."""
    raise NotImplementedError()
...
def get_pooled_pg_core(connection_string, pool_size=None, *, cursor_factory=None,
  ...
  """Creates a pooled PostgreSQL core.
