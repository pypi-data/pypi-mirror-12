...
_VECTORGRAPH = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='double_vectors', full_name='VectorGraph.double_vectors', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='string_vectors', full_name='VectorGraph.string_vectors', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='int32_vectors', full_name='VectorGraph.int32_vectors', index=8,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='int64_vectors', full_name='VectorGraph.int64_vectors', index=9,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='float_vectors', full_name='VectorGraph.float_vectors', index=10,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='bool_vectors', full_name='VectorGraph.bool_vectors', index=11,
  ...
  nested_types=[_VECTORGRAPH_EDGE, _VECTORGRAPH_INT32ATTRIBUTEVECTOR, _VECTORGRAPH_INT64ATTRIBUTEVECTOR, _VECTORGRAPH_FLOATATTRIBUTEVECTOR, _VECTORGRAPH_DOUBLEATTRIBUTEVECTOR, _VECTORGRAPH_STRINGATTRIBUTEVECTOR, _VECTORGRAPH_BOOLATTRIBUTEVECTOR, ],
  enum_types=[
