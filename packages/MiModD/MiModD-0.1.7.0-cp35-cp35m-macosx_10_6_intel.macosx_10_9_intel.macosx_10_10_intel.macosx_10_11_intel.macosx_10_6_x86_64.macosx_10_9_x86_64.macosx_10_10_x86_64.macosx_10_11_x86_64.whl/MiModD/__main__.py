...
vaf_group.add_argument('-m', '--mapping_sample', metavar='sample_name', help='name of the sample (as appearing in the input vcf file) for which variants should be mapped')
...
scatter_group.add_argument('-l', '--loess-span', metavar='FLOAT', default=argparse.SUPPRESS, help='span parameter for the Loess regression line through the linkage data (default: 0.1)')
