...
class KPdb(Pdb):
	...
	def do_clear(self, arg):
		...
		if self.datetime_break_func is not None:
			self._break_at_function(self.datetime_break_func, cond=self.datetime_break_cond)
	'''
	clear_and_break function
	DESC: clear all existing breakpoints and reset multiple line break point	
	USAGE: clear_and_break filename:lineno1,lineno2
	'''	
	def do_clear_and_break(self, arg, temporary = 0):
