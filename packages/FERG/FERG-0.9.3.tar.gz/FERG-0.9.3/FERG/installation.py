...
class installation:
	...
	'''
	def __init__(self, db, circuits_mesures = [], electric_devices = [], seuil_delestage = None, buzzer = None, f_json = 'installation.json', display = None, name = "FERG"):
		'''Initialisation
