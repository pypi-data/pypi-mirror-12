...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Discussion.last_vote_date'
        db.add_column(u'odnoklassniki_discussions_discussion', 'last_vote_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'Discussion.votes_count'
        db.add_column(u'odnoklassniki_discussions_discussion', 'votes_count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Discussion.question'
        db.add_column(u'odnoklassniki_discussions_discussion', 'question',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Discussion.last_vote_date'
        db.delete_column(u'odnoklassniki_discussions_discussion', 'last_vote_date')

        # Deleting field 'Discussion.votes_count'
        db.delete_column(u'odnoklassniki_discussions_discussion', 'votes_count')

        # Deleting field 'Discussion.question'
        db.delete_column(u'odnoklassniki_discussions_discussion', 'question')
    ...
    models = {
        ...
        u'odnoklassniki_discussions.discussion': {
            ...
            'last_vote_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            ...
            'votes_count': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'})
        },
