...
def  enhanced_integrate(t, step=1, fwhm=None, max_dev_percent=20, min_area=100, mslevel=1):
    ...
    emg1=_special_integrate(t, a=1*step, mslevel=mslevel)
    emg2=_special_integrate(t, a=2*step, mslevel=mslevel)
    emg3=_special_integrate(t, a=0.5/step, mslevel=mslevel)
    ...
    if len(remaining):
        print remaining
        remaining=gauss_integrate(remaining, mslevel=mslevel)
...
def _special_integrate(t, a=1, mslevel=1):
    t1=t.copy()
    exp=t1.getColumn
...
def gauss_integrate(t, times_sigma=1.96, mslevel=1):
