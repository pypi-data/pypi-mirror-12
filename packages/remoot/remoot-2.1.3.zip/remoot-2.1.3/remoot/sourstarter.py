...
class SmartStarter(object):
    ...
    def start(self):
        ...
        boot_script = self._make_boot_script(self.childaddr, init)
    ...
    def _make_boot_script(self, myaddr, init):
    ...
    def _make_zip_content(self, preloaded_packages):
        import remoot
        packages = list(preloaded_packages) + [remoot, sourblossom, twistit, utwist]
