...
@tag2
    Calling the bagging constructor:
        ...
        Note the following two new constructor parameters:
...
@tag2
    calculate_class_priors()
            ...
            to estimate the class priors for the training data samples found 
            in each bag.
...
@tag2
    construct_decision_trees_for_bags()
            ...
            Calls on the appropriate method of the main DecisionTree class
            to construct a decision tree from the training data in each
            bag.
...
@tag2
    display_classification_results_for_each_bag()
            ...
            Displays separately the classification decision made by each the
...
@tag2
    get_majority_vote_classification()
        ...
        call these methods for classifying individual samples and for bulk
        classification when you place all your test samples in a single file.
