...
##  20% additional samples will be added to the samples in each bag.  Suppose, the
##  disjoint partition of the training data results in 100 samples in a bag B.  When
##  bag_overlap_fraction is set to 0.20, another 20 samples will be drawn from the
##  the other bags and added to the content of bag B.  After that, the number of
##  samples in bag B will be 120.



import DecisionTreeWithBagging

training_datafile = "stage3cancer_noquotes.csv"
...
print("Class the test sample with each decision tree....")
