...
_PROXFUNCTION_TYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='LOG_SUM_EXP', index=17, number=100,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MAX', index=18, number=101,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NORM_2', index=19, number=102,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NORM_INF', index=20, number=103,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SECOND_ORDER_CONE', index=21, number=104,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SUM_LARGEST', index=22, number=105,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='TOTAL_VARIATION_1D', index=23, number=106,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='LAMBDA_MAX', index=24, number=200,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MATRIX_FRAC', index=25, number=201,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NEG_LOG_DET', index=26, number=202,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NORM_NUCLEAR', index=27, number=203,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SEMIDEFINITE', index=28, number=204,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SIGMA_MAX', index=29, number=205,
      options=None,
      type=None),
  ],
  containing_type=None,
...
_PROXFUNCTION = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='arg_size', full_name='ProxFunction.arg_size', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='sum_largest_params', full_name='ProxFunction.sum_largest_params', index=3,
      number=4, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='scaled_zone_params', full_name='ProxFunction.scaled_zone_params', index=4,
