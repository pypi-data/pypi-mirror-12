...
setup(
  ...
  # data_files=[
  #   ('etb/demos/make',
  #    ['etb/demos/make/etb-make.in',
  #     'etb/demos/make/etb_conf.ini',
  #     'etb/demos/make/README',
  #     'etb/demos/make/wrappers/gcc_wrapper.py'] +
  #    glob.glob('demos/make/*.[ch]')),
  #   ('etb/demos/make/wrappers', glob.glob('demos/make/wrappers/*.py')),
  #   ('etb/demos/make/rules', glob.glob('demos/make/rules/*')),
  #   ('etb/demos/allsat2',
