...
class TestGitHub2GitLab(object):
    ...
    def test_gitmirror(self, m_gitlab_create_remote):
        ...
        assert gitlab.commit('pull/1/head') == github.commit('pull/1/head')
        ...
        head_1 = gitlab.commit('pull/3/head')
        assert head_1 == github.commit('pull/3/head')
        ...
        head_2 = gitlab.commit('pull/3/head')
        assert head_1 != head_2
        assert head_2 == github.commit('pull/3/head')
