...
def load_data(fname, numbersonly=False, headerlines=None, mincols=None,
    ...
    fname : :class:`~python:str`
        input file
    numbersonly : :class:`~python:bool`, optional
    headerlines : :class:`~python:int`, optional
        number of headerlines to look for and extract
    mincols : :class:`~python:int`, optional
        number of data columns to look for
    skip_blank_lines : :class:`~python:bool`, optional
    skiplinesbeforeheader :
    skiplines : :class:`~python:int`, optional
        number of lines to skip
    startlinestr : :class:`~python:str`, optional
        string used to indicate last line of text before start of data

    Returns
    -------
    (headers, data) : :class:`~python:tuple`
        header is a list of str names denoting the variables in the file.
        data is a :class:`~numpy:numpy.ndarray` of data.
