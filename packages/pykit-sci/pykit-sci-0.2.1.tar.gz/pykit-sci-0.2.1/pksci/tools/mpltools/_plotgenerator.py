...
class XYPlot(MPLPlot):
    ...
    def plot_array(self):
        ...
        for dataset_id, dataset in self._datasets.items():
            ...
            linewidth = dataset_plotconfig.linewidths
            markercolor = dataset_plotconfig.markercolors
            label = dataset_plotconfig.labels
            alpha = dataset_plotconfig.alphas
            ...
            if dataset.axhline:
                ...
                xdata = xdata * self._plotconfig.datasets.xscale_factor
                ydata = ydata * self._plotconfig.datasets.yscale_factors
