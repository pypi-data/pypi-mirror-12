...
def write_version_py(filename='pksci/version.py'):
    cnt = """
# THIS FILE IS GENERATED FROM PYKIT-SCI SETUP.PY
...
def configuration(parent_package='', top_path=None):
    ...
    config.get_version('pksci/version.py')
...
def setup_package():
    ...
    setup_options = dict(
        ...
        zip_safe=False,
        install_requires=['numpy>=1.9.3', 'scipy>=0.16.0', 'pint>=0.6',
                          'openpyxl>=2.2.6', 'configobj>=5.0.6'],
        entry_points={
            'console_scripts': [
