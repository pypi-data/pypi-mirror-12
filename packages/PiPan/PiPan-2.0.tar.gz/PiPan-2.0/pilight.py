...
# 10/27/15   Michael Giles   Modified for mindsensors_i2c
#
# this is driver for the mindsensors.com PiLight with any RGB values 
...
class PILIGHT(mindsensors_i2c):
    ...
    def __init__(self, pilight_address = PILIGHT_ADDRESS):
        mindsensors_i2c.__init__(self, pilight_address >> 1)   
