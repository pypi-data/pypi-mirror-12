...
class Coder:
	...
	def code (self, world):
		...
		self.cDefaultInits = {
			...
			'Register': '0',
			'Timer': '{0}nowInexact'.format (self.plcPrefix)
		}
...
#define {0}reset2(timer, condition) if (condition) timer = ({0}nowInexact)
#define {0}reset1(timer) timer = ({0}nowInexact)
#define {0}elapsed1(timer) (1e-3 * ({0}nowInexact - timer))
