...
class Coder:
	...
	def code (self, world):
		...
		self.nativeCode = world._codes [0] if world._codes else None
...
'''
		...
		self.targetFile = open ('{0}.{1}'.format (_programDir, 'ino'), 'w')		
		self.targetFile.write (generatedCode + self.nativeCode.get ())
		self.targetFile.close ()
