...
- CODE GENERATION FOR ARDUINO BOARDS ADDED as described in `SimPyLCHowTo <http://www.qquick.org/simpylchowto>`_.

Bugs fixed:

- None. Note that this is a beta version due to the addition of Arduino code generation. If you need a stable version and don't need code generation, download 1.2.7.
