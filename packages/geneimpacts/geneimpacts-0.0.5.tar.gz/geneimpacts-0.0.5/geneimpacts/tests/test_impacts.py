...
def test_81():
    v = VEP("missense_variant|Aca/Gca|T/A|ENSG00000186092|OR4F5|ENST00000335137|1/1|benign(0.003)|tolerated(0.82)|141/305|protein_coding|ENST00000335137.3:c.421T>G|ENSP00000334393.3:p.Thr141Ala|",
            keys="Consequence|Codons|Amino_acids|Gene|SYMBOL|Feature|EXON|PolyPhen|SIFT|Protein_position|BIOTYPE|HGVSc|HGVSp|HGVS_OFFSET".split("|"))
    assert v.gene == "OR4F5"
