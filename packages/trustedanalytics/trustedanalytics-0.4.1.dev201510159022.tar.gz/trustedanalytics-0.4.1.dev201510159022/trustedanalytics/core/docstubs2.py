...
# Auto-generated file for API static documentation stubs (2015-10-15T04:56:01.761063)
#
# **DO NOT EDIT**
...
class CollaborativeFilteringModel(object):
    ...
    def recommend(self, name, top_k):
        ...
        :returns: See :ref:`Collaborative Filtering Train
            <python_api/models/model-collaborative_filtering/train>` for more information.
        :rtype: <bound method AtkEntityType.__name__ of <trustedanalytics.rest.jsonschema.AtkEntityType object at 0x7f02b59267d0>>
        """
        return None
    ...
    def train(self, frame, user_col_name, item_col_name, rating_col_name, evaluation_function=None, num_factors=None, max_iterations=None, convergence_threshold=None, regularization=None, bias_on=None, min_value=None, max_value=None, learning_curve_interval=None, cgd_iterations=None):
        ...
        :param frame: 
        :type frame: <bound method AtkEntityType.__name__ of <trustedanalytics.rest.jsonschema.AtkEntityType object at 0x7f02b59267d0>>
...
class RandomForestClassifierModel(object):
    ...
    @doc_stub
    def train(self, frame, label_column, observation_columns, num_classes=2, num_trees=1, impurity='gini', max_depth=4, max_bins=100, seed=-161430041, categorical_features_info=None, feature_subset_category=None):
        """
        ...
        :type max_bins: int32
        :param seed: (default=-161430041)  Random seed for bootstrapping and choosing feature subsets. Default is a randomly chosen seed.
        :type seed: int32
...
class RandomForestRegressorModel(object):
    ...
    @doc_stub
    def train(self, frame, label_column, observation_columns, num_trees=1, impurity='variance', max_depth=4, max_bins=100, seed=-1139420538, categorical_features_info=None, feature_subset_category=None):
        """
        ...
        :param max_bins: (default=100)  Maximum number of bins used for splitting features. Default is 100.
        :type max_bins: int32
        :param seed: (default=-1139420538)  Random seed for bootstrapping and choosing feature subsets. Default is a randomly chosen seed.
        :type seed: int32
        :param categorical_features_info: (default=None)  
        :type categorical_features_info: None
        :param feature_subset_category: (default=None)  Number of features to consider for splits at each node. Supported values "auto", "all", "sqrt","log2", "onethird".
