...
class Model(object):
    ...
    @staticmethod
    def make(name, dbargkws=None, tablename=None, pool_size=1):
        pool = MySQLConnectionPool(pool_name="miniorm_pooling", pool_size=pool_size, pool_reset_session=True, **dbargkws)
