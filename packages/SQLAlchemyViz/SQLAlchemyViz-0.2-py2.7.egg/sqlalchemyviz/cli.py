...
def main():
    ...
    parser.add_argument('--sort-columns', action='store_true',
                        default=False,
                        dest='sort_columns',
                        help='Sort columns primary key first and alphabetically.')

    parser.add_argument('--unique-relations', action='store_true',
                        default=False,
                        dest='unique_relations',
                        help='Draw relations between tables only once (if multiple foreign keys reference the same table).')

    parser.add_argument('--show-constraints', action='store_true', default=False,
