...
class TestKeycodeConstants(unittest.TestCase):
    ...
    def test_SDLK_PRINTSCREEN(self):
        ...
        self.assertEqual(SDLK_PRINTSCREEN, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_PRINTSCREEN))

    def test_SDLK_SCROLLLOCK(self):
        self.assertIs(type(SDLK_SCROLLLOCK), int)
        self.assertEqual(SDLK_SCROLLLOCK, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_SCROLLLOCK))

    def test_SDLK_PAUSE(self):
        self.assertIs(type(SDLK_PAUSE), int)
        self.assertEqual(SDLK_PAUSE, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_PAUSE))

    def test_SDLK_INSERT(self):
        self.assertIs(type(SDLK_INSERT), int)
        self.assertEqual(SDLK_INSERT, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_INSERT))
    ...
    def test_SDLK_PAGEUP(self):
        ...
        self.assertEqual(SDLK_PAGEUP, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_PAGEUP))
    ...
    def test_SDLK_PAGEDOWN(self):
        ...
        self.assertEqual(SDLK_PAGEDOWN, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_PAGEDOWN))

    def test_SDLK_RIGHT(self):
        self.assertIs(type(SDLK_RIGHT), int)
        self.assertEqual(SDLK_RIGHT, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_RIGHT))
    ...
    def test_SDLK_NUMLOCKCLEAR(self):
        ...
        self.assertEqual(SDLK_NUMLOCKCLEAR, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_NUMLOCKCLEAR))

    def test_SDLK_KP_DIVIDE(self):
        self.assertIs(type(SDLK_KP_DIVIDE), int)
        self.assertEqual(SDLK_KP_DIVIDE, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_KP_DIVIDE))

    def test_SDLK_KP_MULTIPLY(self):
        self.assertIs(type(SDLK_KP_MULTIPLY), int)
        self.assertEqual(SDLK_KP_MULTIPLY, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_KP_MULTIPLY))

    def test_SDLK_KP_MINUS(self):
        self.assertIs(type(SDLK_KP_MINUS), int)
        self.assertEqual(SDLK_KP_MINUS, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_KP_MINUS))

    def test_SDLK_KP_PLUS(self):
        self.assertIs(type(SDLK_KP_PLUS), int)
        self.assertEqual(SDLK_KP_PLUS, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_KP_PLUS))

    def test_SDLK_KP_ENTER(self):
        self.assertIs(type(SDLK_KP_ENTER), int)
        self.assertEqual(SDLK_KP_ENTER, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_KP_ENTER))
    ...
    def test_SDLK_KP_PERIOD(self):
        ...
        self.assertEqual(SDLK_KP_PERIOD, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_KP_PERIOD))

    def test_SDLK_APPLICATION(self):
        self.assertIs(type(SDLK_APPLICATION), int)
        self.assertEqual(SDLK_APPLICATION, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_APPLICATION))

    def test_SDLK_POWER(self):
        self.assertIs(type(SDLK_POWER), int)
        self.assertEqual(SDLK_POWER, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_POWER))

    def test_SDLK_KP_EQUALS(self):
        self.assertIs(type(SDLK_KP_EQUALS), int)
        self.assertEqual(SDLK_KP_EQUALS, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_KP_EQUALS))
    ...
    def test_SDLK_EXECUTE(self):
        ...
        self.assertEqual(SDLK_EXECUTE, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_EXECUTE))
    ...
    def test_SDLK_SELECT(self):
        ...
        self.assertEqual(SDLK_SELECT, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_SELECT))
    ...
    def test_SDLK_AGAIN(self):
        ...
        self.assertEqual(SDLK_AGAIN, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_AGAIN))
    ...
    def test_SDLK_PASTE(self):
        ...
        self.assertEqual(SDLK_PASTE, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_PASTE))
    ...
    def test_SDLK_VOLUMEUP(self):
        ...
        self.assertEqual(SDLK_VOLUMEUP, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_VOLUMEUP))

    def test_SDLK_VOLUMEDOWN(self):
        self.assertIs(type(SDLK_VOLUMEDOWN), int)
        self.assertEqual(SDLK_VOLUMEDOWN, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_VOLUMEDOWN))

    def test_SDLK_KP_COMMA(self):
        self.assertIs(type(SDLK_KP_COMMA), int)
        self.assertEqual(SDLK_KP_COMMA, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_KP_COMMA))

    def test_SDLK_KP_EQUALSAS400(self):
        self.assertIs(type(SDLK_KP_EQUALSAS400), int)
        self.assertEqual(SDLK_KP_EQUALSAS400, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_KP_EQUALSAS400))

    def test_SDLK_ALTERASE(self):
        self.assertIs(type(SDLK_ALTERASE), int)
        self.assertEqual(SDLK_ALTERASE, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_ALTERASE))

    def test_SDLK_SYSREQ(self):
        self.assertIs(type(SDLK_SYSREQ), int)
        self.assertEqual(SDLK_SYSREQ, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_SYSREQ))

    def test_SDLK_CANCEL(self):
        self.assertIs(type(SDLK_CANCEL), int)
        self.assertEqual(SDLK_CANCEL, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_CANCEL))

    def test_SDLK_CLEAR(self):
        self.assertIs(type(SDLK_CLEAR), int)
        self.assertEqual(SDLK_CLEAR, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_CLEAR))

    def test_SDLK_PRIOR(self):
        self.assertIs(type(SDLK_PRIOR), int)
        self.assertEqual(SDLK_PRIOR, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_PRIOR))

    def test_SDLK_RETURN2(self):
        self.assertIs(type(SDLK_RETURN2), int)
        self.assertEqual(SDLK_RETURN2, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_RETURN2))

    def test_SDLK_SEPARATOR(self):
        self.assertIs(type(SDLK_SEPARATOR), int)
        self.assertEqual(SDLK_SEPARATOR, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_SEPARATOR))

    def test_SDLK_OUT(self):
        self.assertIs(type(SDLK_OUT), int)
        self.assertEqual(SDLK_OUT, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_OUT))
    ...
    def test_SDLK_CLEARAGAIN(self):
        ...
        self.assertEqual(SDLK_CLEARAGAIN, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_CLEARAGAIN))

    def test_SDLK_CRSEL(self):
        self.assertIs(type(SDLK_CRSEL), int)
        self.assertEqual(SDLK_CRSEL, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_CRSEL))

    def test_SDLK_EXSEL(self):
        self.assertIs(type(SDLK_EXSEL), int)
        self.assertEqual(SDLK_EXSEL, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_EXSEL))

    def test_SDLK_KP_00(self):
        self.assertIs(type(SDLK_KP_00), int)
        self.assertEqual(SDLK_KP_00, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_KP_00))

    def test_SDLK_KP_000(self):
        self.assertIs(type(SDLK_KP_000), int)
        self.assertEqual(SDLK_KP_000, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_KP_000))

    def test_SDLK_THOUSANDSSEPARATOR(self):
        self.assertIs(type(SDLK_THOUSANDSSEPARATOR), int)
        self.assertEqual(SDLK_THOUSANDSSEPARATOR, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_THOUSANDSSEPARATOR))

    def test_SDLK_DECIMALSEPARATOR(self):
        self.assertIs(type(SDLK_DECIMALSEPARATOR), int)
        self.assertEqual(SDLK_DECIMALSEPARATOR, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_DECIMALSEPARATOR))

    def test_SDLK_CURRENCYUNIT(self):
        self.assertIs(type(SDLK_CURRENCYUNIT), int)
        self.assertEqual(SDLK_CURRENCYUNIT, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_CURRENCYUNIT))

    def test_SDLK_CURRENCYSUBUNIT(self):
        self.assertIs(type(SDLK_CURRENCYSUBUNIT), int)
        self.assertEqual(SDLK_CURRENCYSUBUNIT, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_CURRENCYSUBUNIT))

    def test_SDLK_KP_LEFTPAREN(self):
        self.assertIs(type(SDLK_KP_LEFTPAREN), int)
        self.assertEqual(SDLK_KP_LEFTPAREN, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_KP_LEFTPAREN))

    def test_SDLK_KP_RIGHTPAREN(self):
        self.assertIs(type(SDLK_KP_RIGHTPAREN), int)
        self.assertEqual(SDLK_KP_RIGHTPAREN, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_KP_RIGHTPAREN))

    def test_SDLK_KP_LEFTBRACE(self):
        self.assertIs(type(SDLK_KP_LEFTBRACE), int)
        self.assertEqual(SDLK_KP_LEFTBRACE, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_KP_LEFTBRACE))

    def test_SDLK_KP_RIGHTBRACE(self):
        self.assertIs(type(SDLK_KP_RIGHTBRACE), int)
        self.assertEqual(SDLK_KP_RIGHTBRACE, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_KP_RIGHTBRACE))

    def test_SDLK_KP_TAB(self):
        self.assertIs(type(SDLK_KP_TAB), int)
        self.assertEqual(SDLK_KP_TAB, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_KP_TAB))

    def test_SDLK_KP_BACKSPACE(self):
        self.assertIs(type(SDLK_KP_BACKSPACE), int)
        self.assertEqual(SDLK_KP_BACKSPACE, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_KP_BACKSPACE))
    ...
    def test_SDLK_KP_XOR(self):
        ...
        self.assertEqual(SDLK_KP_XOR, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_KP_XOR))

    def test_SDLK_KP_POWER(self):
        self.assertIs(type(SDLK_KP_POWER), int)
        self.assertEqual(SDLK_KP_POWER, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_KP_POWER))

    def test_SDLK_KP_PERCENT(self):
        self.assertIs(type(SDLK_KP_PERCENT), int)
        self.assertEqual(SDLK_KP_PERCENT, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_KP_PERCENT))

    def test_SDLK_KP_LESS(self):
        self.assertIs(type(SDLK_KP_LESS), int)
        self.assertEqual(SDLK_KP_LESS, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_KP_LESS))

    def test_SDLK_KP_GREATER(self):
        self.assertIs(type(SDLK_KP_GREATER), int)
        self.assertEqual(SDLK_KP_GREATER, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_KP_GREATER))

    def test_SDLK_KP_AMPERSAND(self):
        self.assertIs(type(SDLK_KP_AMPERSAND), int)
        self.assertEqual(SDLK_KP_AMPERSAND, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_KP_AMPERSAND))

    def test_SDLK_KP_DBLAMPERSAND(self):
        self.assertIs(type(SDLK_KP_DBLAMPERSAND), int)
        self.assertEqual(SDLK_KP_DBLAMPERSAND, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_KP_DBLAMPERSAND))

    def test_SDLK_KP_VERTICALBAR(self):
        self.assertIs(type(SDLK_KP_VERTICALBAR), int)
        self.assertEqual(SDLK_KP_VERTICALBAR, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_KP_VERTICALBAR))

    def test_SDLK_KP_DBLVERTICALBAR(self):
        self.assertIs(type(SDLK_KP_DBLVERTICALBAR), int)
        self.assertEqual(SDLK_KP_DBLVERTICALBAR, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_KP_DBLVERTICALBAR))

    def test_SDLK_KP_COLON(self):
        self.assertIs(type(SDLK_KP_COLON), int)
        self.assertEqual(SDLK_KP_COLON, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_KP_COLON))

    def test_SDLK_KP_HASH(self):
        self.assertIs(type(SDLK_KP_HASH), int)
        self.assertEqual(SDLK_KP_HASH, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_KP_HASH))

    def test_SDLK_KP_SPACE(self):
        self.assertIs(type(SDLK_KP_SPACE), int)
        self.assertEqual(SDLK_KP_SPACE, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_KP_SPACE))

    def test_SDLK_KP_AT(self):
        self.assertIs(type(SDLK_KP_AT), int)
        self.assertEqual(SDLK_KP_AT, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_KP_AT))

    def test_SDLK_KP_EXCLAM(self):
        self.assertIs(type(SDLK_KP_EXCLAM), int)
        self.assertEqual(SDLK_KP_EXCLAM, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_KP_EXCLAM))

    def test_SDLK_KP_MEMSTORE(self):
        self.assertIs(type(SDLK_KP_MEMSTORE), int)
        self.assertEqual(SDLK_KP_MEMSTORE, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_KP_MEMSTORE))

    def test_SDLK_KP_MEMRECALL(self):
        self.assertIs(type(SDLK_KP_MEMRECALL), int)
        self.assertEqual(SDLK_KP_MEMRECALL, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_KP_MEMRECALL))

    def test_SDLK_KP_MEMCLEAR(self):
        self.assertIs(type(SDLK_KP_MEMCLEAR), int)
        self.assertEqual(SDLK_KP_MEMCLEAR, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_KP_MEMCLEAR))

    def test_SDLK_KP_MEMADD(self):
        self.assertIs(type(SDLK_KP_MEMADD), int)
        self.assertEqual(SDLK_KP_MEMADD, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_KP_MEMADD))

    def test_SDLK_KP_MEMSUBTRACT(self):
        self.assertIs(type(SDLK_KP_MEMSUBTRACT), int)
        self.assertEqual(SDLK_KP_MEMSUBTRACT, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_KP_MEMSUBTRACT))

    def test_SDLK_KP_MEMMULTIPLY(self):
        self.assertIs(type(SDLK_KP_MEMMULTIPLY), int)
        self.assertEqual(SDLK_KP_MEMMULTIPLY, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_KP_MEMMULTIPLY))

    def test_SDLK_KP_MEMDIVIDE(self):
        self.assertIs(type(SDLK_KP_MEMDIVIDE), int)
        self.assertEqual(SDLK_KP_MEMDIVIDE, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_KP_MEMDIVIDE))

    def test_SDLK_KP_PLUSMINUS(self):
        self.assertIs(type(SDLK_KP_PLUSMINUS), int)
        self.assertEqual(SDLK_KP_PLUSMINUS, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_KP_PLUSMINUS))

    def test_SDLK_KP_CLEAR(self):
        self.assertIs(type(SDLK_KP_CLEAR), int)
        self.assertEqual(SDLK_KP_CLEAR, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_KP_CLEAR))

    def test_SDLK_KP_CLEARENTRY(self):
        self.assertIs(type(SDLK_KP_CLEARENTRY), int)
        self.assertEqual(SDLK_KP_CLEARENTRY, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_KP_CLEARENTRY))

    def test_SDLK_KP_BINARY(self):
        self.assertIs(type(SDLK_KP_BINARY), int)
        self.assertEqual(SDLK_KP_BINARY, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_KP_BINARY))

    def test_SDLK_KP_OCTAL(self):
        self.assertIs(type(SDLK_KP_OCTAL), int)
        self.assertEqual(SDLK_KP_OCTAL, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_KP_OCTAL))

    def test_SDLK_KP_DECIMAL(self):
        self.assertIs(type(SDLK_KP_DECIMAL), int)
        self.assertEqual(SDLK_KP_DECIMAL, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_KP_DECIMAL))

    def test_SDLK_KP_HEXADECIMAL(self):
        self.assertIs(type(SDLK_KP_HEXADECIMAL), int)
        self.assertEqual(SDLK_KP_HEXADECIMAL, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_KP_HEXADECIMAL))

    def test_SDLK_LCTRL(self):
        self.assertIs(type(SDLK_LCTRL), int)
        self.assertEqual(SDLK_LCTRL, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_LCTRL))

    def test_SDLK_LSHIFT(self):
        self.assertIs(type(SDLK_LSHIFT), int)
        self.assertEqual(SDLK_LSHIFT, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_LSHIFT))
    ...
    def test_SDLK_RCTRL(self):
        ...
        self.assertEqual(SDLK_RCTRL, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_RCTRL))

    def test_SDLK_RSHIFT(self):
        self.assertIs(type(SDLK_RSHIFT), int)
        self.assertEqual(SDLK_RSHIFT, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_RSHIFT))
    ...
    def test_SDLK_AUDIONEXT(self):
        ...
        self.assertEqual(SDLK_AUDIONEXT, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_AUDIONEXT))

    def test_SDLK_AUDIOPREV(self):
        self.assertIs(type(SDLK_AUDIOPREV), int)
        self.assertEqual(SDLK_AUDIOPREV, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_AUDIOPREV))

    def test_SDLK_AUDIOSTOP(self):
        self.assertIs(type(SDLK_AUDIOSTOP), int)
        self.assertEqual(SDLK_AUDIOSTOP, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_AUDIOSTOP))

    def test_SDLK_AUDIOPLAY(self):
        self.assertIs(type(SDLK_AUDIOPLAY), int)
        self.assertEqual(SDLK_AUDIOPLAY, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_AUDIOPLAY))

    def test_SDLK_AUDIOMUTE(self):
        self.assertIs(type(SDLK_AUDIOMUTE), int)
        self.assertEqual(SDLK_AUDIOMUTE, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_AUDIOMUTE))

    def test_SDLK_MEDIASELECT(self):
        self.assertIs(type(SDLK_MEDIASELECT), int)
        self.assertEqual(SDLK_MEDIASELECT, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_MEDIASELECT))
    ...
    def test_SDLK_CALCULATOR(self):
        ...
        self.assertEqual(SDLK_CALCULATOR, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_CALCULATOR))

    def test_SDLK_COMPUTER(self):
        self.assertIs(type(SDLK_COMPUTER), int)
        self.assertEqual(SDLK_COMPUTER, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_COMPUTER))

    def test_SDLK_AC_SEARCH(self):
        self.assertIs(type(SDLK_AC_SEARCH), int)
        self.assertEqual(SDLK_AC_SEARCH, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_AC_SEARCH))

    def test_SDLK_AC_HOME(self):
        self.assertIs(type(SDLK_AC_HOME), int)
        self.assertEqual(SDLK_AC_HOME, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_AC_HOME))

    def test_SDLK_AC_BACK(self):
        self.assertIs(type(SDLK_AC_BACK), int)
        self.assertEqual(SDLK_AC_BACK, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_AC_BACK))

    def test_SDLK_AC_FORWARD(self):
        self.assertIs(type(SDLK_AC_FORWARD), int)
        self.assertEqual(SDLK_AC_FORWARD, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_AC_FORWARD))

    def test_SDLK_AC_STOP(self):
        self.assertIs(type(SDLK_AC_STOP), int)
        self.assertEqual(SDLK_AC_STOP, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_AC_STOP))

    def test_SDLK_AC_REFRESH(self):
        self.assertIs(type(SDLK_AC_REFRESH), int)
        self.assertEqual(SDLK_AC_REFRESH, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_AC_REFRESH))

    def test_SDLK_AC_BOOKMARKS(self):
        self.assertIs(type(SDLK_AC_BOOKMARKS), int)
        self.assertEqual(SDLK_AC_BOOKMARKS, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_AC_BOOKMARKS))

    def test_SDLK_BRIGHTNESSDOWN(self):
        self.assertIs(type(SDLK_BRIGHTNESSDOWN), int)
        self.assertEqual(SDLK_BRIGHTNESSDOWN, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_BRIGHTNESSDOWN))

    def test_SDLK_BRIGHTNESSUP(self):
        self.assertIs(type(SDLK_BRIGHTNESSUP), int)
        self.assertEqual(SDLK_BRIGHTNESSUP, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_BRIGHTNESSUP))

    def test_SDLK_DISPLAYSWITCH(self):
        self.assertIs(type(SDLK_DISPLAYSWITCH), int)
        self.assertEqual(SDLK_DISPLAYSWITCH, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_DISPLAYSWITCH))

    def test_SDLK_KBDILLUMTOGGLE(self):
        self.assertIs(type(SDLK_KBDILLUMTOGGLE), int)
        self.assertEqual(SDLK_KBDILLUMTOGGLE, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_KBDILLUMTOGGLE))

    def test_SDLK_KBDILLUMDOWN(self):
        self.assertIs(type(SDLK_KBDILLUMDOWN), int)
        self.assertEqual(SDLK_KBDILLUMDOWN, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_KBDILLUMDOWN))

    def test_SDLK_KBDILLUMUP(self):
        self.assertIs(type(SDLK_KBDILLUMUP), int)
        self.assertEqual(SDLK_KBDILLUMUP, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_KBDILLUMUP))

    def test_SDLK_EJECT(self):
        self.assertIs(type(SDLK_EJECT), int)
        self.assertEqual(SDLK_EJECT, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_EJECT))

    def test_SDLK_SLEEP(self):
        self.assertIs(type(SDLK_SLEEP), int)
        self.assertEqual(SDLK_SLEEP, SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_SLEEP))
