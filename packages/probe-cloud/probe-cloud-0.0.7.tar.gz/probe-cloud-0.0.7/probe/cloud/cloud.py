...
class Cloud(object):
    ...
    def run_command(self, command):
        ...
        simulation = Process(target=run_cmd, args=(child_conn, command))
        simulation.start()
        ...
        with open('pids.log', 'a') as f:
            f.write('{},{},{}\n'.format(os.getpid(), simulation.pid, sim_pid))
