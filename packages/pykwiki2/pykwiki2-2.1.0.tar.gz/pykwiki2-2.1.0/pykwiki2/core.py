...
class Config(object):
    ...
    def check(self):
        ...
        if self.version != 2:
            raise Exception('conf.version does not exist or is incorrect')
...
class PostController(object):
    ...
    def cache_theme(self):
        ...
        conf.logger.info('Caching theme files from %s'%(conf.theme_path))
        ...
        # Cache scss
        conf.logger.info("Compiling scss to static/styles/style.css")
