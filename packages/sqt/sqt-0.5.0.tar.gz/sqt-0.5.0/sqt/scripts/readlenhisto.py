...
def get_argument_parser():
	...
	add('--bins', default=50, type=int, help='Number of bins in the plot. '
		'Default: %(default)s')
	add('--maxy', default=None, type=float, help='Maximum y in plot')
	add('--left', default=0, type=float, help='Minimum x in plot')
	add('--outliers', default=False, action='store_true',
