...
cpdef object decode_twobit(unsigned long seq, type dtype= *)
cpdef object decode_fourbit(unsigned long seq, type dtype= *)
cpdef list decode(unsigned long i, dict inv_codemap)
