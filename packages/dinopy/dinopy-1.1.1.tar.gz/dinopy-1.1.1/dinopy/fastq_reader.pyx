...
cdef class FastqReader:
    ...
    def __init__(self, source):
        ...
        - :py:meth:`lines`: Return an iterator over all lines in the FASTQ file.
        ...
        - :py:meth:`reads`: Return an iterator over all reads in the FASTQ file.
    ...
    def reads(
        ...
        Yields:
            named tuple: An iterator over all reads in the FASTQ file.
            The type of the items relies on the input parameters:
