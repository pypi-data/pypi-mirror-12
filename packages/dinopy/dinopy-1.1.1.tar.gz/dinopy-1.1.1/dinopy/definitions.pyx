...
cdef dict _byte_from_2bit = dict({
    0b00: BASE_A,
    0b01: BASE_C,
    0b10: BASE_G,
    0b11: BASE_T,
...
cdef dict _basenumber_from_2bit = dict({
    0b00: 0,
    0b01: 1,
    0b10: 2,
    0b11: 3,
...
cdef dict _byte_from_4bit = dict({
    0b0000: 0,   #
    0b0001: BASE_A,   # A
    0b0010: BASE_C,   # C
    0b0011: BASE_M,   # M
...
cdef dict _basenumber_from_4bit = dict({
    0b0000: 0,   #
    0b0001: 1,   # A
    0b0010: 2,   # C
    0b0011: 3,   # M
...
cdef dict _basenumber_from_byte = dict({
    BASE_LOWER_A: 0,
    BASE_LOWER_C: 1,
    BASE_LOWER_G: 2,
    BASE_LOWER_T: 3,
...
cdef dict _basenumber_from_byte_suppressed = dict({
    BASE_LOWER_A: 0,
    BASE_LOWER_C: 1,
    BASE_LOWER_G: 2,
    BASE_LOWER_T: 3,
...
cdef dict _unicode_from_byte = dict({
    BASE_LOWER_A: "A",
    BASE_LOWER_C: "C",
    BASE_LOWER_G: "G",
    BASE_LOWER_T: "T",
...
cdef dict _unicode_from_byte_suppressed = dict({
    BASE_LOWER_A: "A",
    BASE_LOWER_C: "C",
    BASE_LOWER_G: "G",
    BASE_LOWER_T: "T",
...
cdef dict _basenumber_from_unicode = dict({
    'A': 0,
    'C': 1,
    'G': 2,
    'T': 3,
...
cdef dict _basenumber_from_unicode_suppressed = dict({
    'A': 0,
    'C': 1,
    'G': 2,
    'T': 3,
...
cdef dict _unicode_from_basenumber = dict({
    0: 'A',
    1: 'C',
    2: 'G',
    3: 'T',
...
cdef dict _byte_from_unicode = dict({
    'A': BASE_A,
    'C': BASE_C,
    'G': BASE_G,
    'T': BASE_T,
...
cdef dict _byte_from_unicode_suppressed = dict({
    'A': BASE_A,
    'C': BASE_C,
    'G': BASE_G,
    'T': BASE_T,
...
cdef dict _byte_from_basenumber = dict({
    0: BASE_A,
    1: BASE_C,
    2: BASE_G,
    3: BASE_T,
...
cdef dict _iupac_complement = dict({
    0b0001: 0b1000,  # A ←→ T
    0b0010: 0b0100,  # C ←→ G
    0b0100: 0b0010,  # G ←→ C
    0b1000: 0b0001,  # T ←→ A
...
cdef dict linetype_as_str = dict({
    START: "start",
    NAME: "name",
    SEQUENCE: "sequence",
    PLUS: "plus",
