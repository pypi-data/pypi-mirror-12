...
cdef class FastaReader:
    ...
    def __init__(self, source, write_fai=False):
        ...
        Supports different iterators, for different level of analysis:
            ...
            - :py:meth:`entries`: Yield all entries of the file and provide information
              about length and position in the genome for all entries.
            - :py:meth:`genome`: Concatenates and returns all data (i.e. all lines except name-lines)
              as a single sequence. Also return an annotation containing chromosome boundaries and
              lengths.
            - :py:meth:`reads`: Interpret the entries of the file as reads and yield
              them either as FastaRead named tuples or only as sequences.
            - :py:meth:`chromosomes`: Interpret the entries of the FASTA file as
            ...
            - :py:meth:`lines`: Yield all lines of the file without interpretation.
        ...
        Note:
            ...
            dtype for the sequence, use :py:meth:`chromosomes` or :py:meth:`random_access` with the appropriate dtype
    ...
    def entries(self, dtype=bytes):
        ...
        chromosomes (:py:meth:`chromosomes` and :py:meth:`reads`), which cater to the specific needs of either
    ...
    def chromosomes(self, object selected_chromosomes=None, dtype=bytes):
        ...
        genome. If all chromosomes are needed, please use :py:meth:`entries` instead.
