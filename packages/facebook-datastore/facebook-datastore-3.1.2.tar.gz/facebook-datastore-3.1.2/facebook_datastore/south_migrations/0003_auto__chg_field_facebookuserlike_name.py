...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FacebookUserLike.name'
        db.alter_column('facebook_datastore_facebookuserlike', 'name', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'FacebookUserLike.name'
        db.alter_column('facebook_datastore_facebookuserlike', 'name', self.gf('django.db.models.fields.CharField')(max_length=250))
