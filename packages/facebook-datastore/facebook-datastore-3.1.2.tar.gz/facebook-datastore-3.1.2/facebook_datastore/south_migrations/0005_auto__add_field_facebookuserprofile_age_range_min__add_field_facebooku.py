...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FacebookUserProfile.age_range_min'
        db.add_column(u'facebook_datastore_facebookuserprofile', 'age_range_min',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'FacebookUserProfile.age_range_max'
        db.add_column(u'facebook_datastore_facebookuserprofile', 'age_range_max',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FacebookUserProfile.age_range_min'
        db.delete_column(u'facebook_datastore_facebookuserprofile', 'age_range_min')

        # Deleting field 'FacebookUserProfile.age_range_max'
        db.delete_column(u'facebook_datastore_facebookuserprofile', 'age_range_max')
