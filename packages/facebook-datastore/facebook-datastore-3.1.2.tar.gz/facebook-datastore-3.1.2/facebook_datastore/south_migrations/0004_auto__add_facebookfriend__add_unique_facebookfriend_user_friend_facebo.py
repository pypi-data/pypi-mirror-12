...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('facebook_datastore_facebookfriend', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('friend_facebook_id', self.gf('django.db.models.fields.BigIntegerField')()),
        ))
        db.send_create_signal('facebook_datastore', ['FacebookFriend'])

        # Adding unique constraint on 'FacebookFriend', fields ['user', 'friend_facebook_id']
        db.create_unique('facebook_datastore_facebookfriend', ['user_id', 'friend_facebook_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'FacebookFriend', fields ['user', 'friend_facebook_id']
        db.delete_unique('facebook_datastore_facebookfriend', ['user_id', 'friend_facebook_id'])

        # Deleting model 'FacebookFriend'
        db.delete_table('facebook_datastore_facebookfriend')
    ...
    models = {
        ...
        'facebook_datastore.facebookfriend': {
