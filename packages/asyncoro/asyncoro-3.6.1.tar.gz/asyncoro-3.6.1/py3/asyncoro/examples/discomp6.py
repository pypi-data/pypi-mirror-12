...
def client_proc(computation, data_file, coro=None):
    ...
    def status_proc(status, location, coro=None):
        ...
        # send data file to server (it could've been sent with
        # Computation itself, but done here to illustrate different
        # files can be sent to different servers)
