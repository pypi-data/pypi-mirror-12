...
import sys
import unittest
from labkit.conformer.conformer import Conformer,TEMPLATE
...
class TestConformer(unittest.TestCase):
    def setUp(self):
        ...
        from  labkit.tests.test_sample import TEST_SAMPLE_LOCATION
        self.origin_path=os.path.abspath(os.curdir)
        os.chdir(TEST_SAMPLE_LOCATION)

        self.c=Conformer()
        # self.seq='CGGG'
        # self.c.from_seq(self.c.conf['SEQ'])
        self.e=Ensemble()
        # print self.c.conf['SEQ']
...
#         self.sample_xyz= self.c.xyz
    ...
    def test_new_individual(self):
        ...
        self.new_individual=Conformer()
        # self.new_individual.father=self.c['_id']
    ...
    H	18.410000 13.130000 10.300000
        ...
        self.new_individual.dump('ttt.pdb','pdf')
