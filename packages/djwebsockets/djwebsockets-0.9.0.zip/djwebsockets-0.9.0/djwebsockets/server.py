...
class WebSocketServer:
    ...
    def receiver(self, websocket, path):
        ...
        while True:
            ...
            connecti_on_closed = websocket.connecti_on_closed
            done, pending = yield from asyncio.wait([receivetask, close_handler, send_handler, connecti_on_closed], return_when=asyncio.FIRST_COMPLETED)
