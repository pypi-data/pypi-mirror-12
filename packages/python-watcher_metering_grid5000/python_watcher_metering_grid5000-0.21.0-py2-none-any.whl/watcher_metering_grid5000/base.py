...
class BaseGrid5000MetricPuller(MetricPuller):
    ...
    available_metrics = [
        "boottime", "bread_sec", "bwrite_sec", "bytes_in", "bytes_out",
        "cpu_aidle", "cpu_arm", "cpu_avm", "cpu_idle", "cpu_intr", "cpu_nice",
        "cpu_num", "cpu_rm", "cpu_speed", "cpu_ssys", "cpu_system", "cpu_user",
        "cpu_vm", "cpu_wait", "cpu_wio", "disk_free", "disk_total",
        "load_fifteen", "load_five", "load_one", "location", "lread_sec",
        "lwrite_sec", "machine_type", "mem_buffers", "mem_cached", "mem_free",
        "mem_shared", "mem_sreclaimable", "mem_total", "mtu", "os_name",
        "os_release", "part_max_used", "phread_sec", "phwrite_sec", "pkts_in",
        "pkts_out", "proc_run", "proc_total", "rcache", "swap_free",
        "swap_total", "sys_clock", "wcache", 'pdu', 'pdu_shared',
    ]
    ...
    def do_pull(self):
        ...
        for site in self.sites:
            ...
            try:
                ...
                measurements.extend(site_measurements)
                ...
                LOG.info("[%s][STATS] Scanned %d sites from %d in total",
                         self.key, self.wrapper.site_stats["num_sites"],
                         len(self.sites))
            finally:
