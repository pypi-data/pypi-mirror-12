...
proc vunit_load {{vsim_extra_args ""}} {
    set vsim_failed [catch {
        eval vsim ${vsim_extra_args} {-modelsimini d:/Programming/github/vunit/vunit/vhdl/check/vunit_out/modelsim/modelsim.ini -wlf {d:/Programming/github/vunit/vunit/vhdl/check/vunit_out/tests/lib.tb_check_stable/modelsim/vsim.wlf} -quiet -t ps -onfinish stop  -g/tb_check_stable/runner_cfg={"enabled_test_cases : Test concurrent checker should pass stable window,,Test concurrent checker should pass window with varying drive strength,,Test concurrent checker should handle weak start and end events,,Test concurrent checker should fail unstable window,,Test concurrent checker should fail window with weak changes to opposite level,,Test concurrent checker should fail on unknown start event,,Test concurrent checker should fail on unknown end event in active window,,Test concurrent checker should fail on stable unknown window,,Test concurrent checker should handle back to back windows,,Test concurrent checker should ignore second of two overlapping windows,,Test concurrent checker should test one cycle windows,,Test concurrent checker with std_logic_vector input should pass unstable window if not enabled,,Test concurrent checker with std_logic input should pass unstable window if not enabled,,Test should handle reversed and or offset expressions,output path : d::/Programming/github/vunit/vunit/vhdl/check/vunit_out/tests/lib.tb_check_stable/,active python runner : true"} lib.tb_check_stable(test_fixture)   -L lib -L vunit_lib}
    }]
    if {${vsim_failed}} {
       echo Command 'vsim ${vsim_extra_args} -modelsimini d:/Programming/github/vunit/vunit/vhdl/check/vunit_out/modelsim/modelsim.ini -wlf {d:/Programming/github/vunit/vunit/vhdl/check/vunit_out/tests/lib.tb_check_stable/modelsim/vsim.wlf} -quiet -t ps -onfinish stop  -g/tb_check_stable/runner_cfg={"enabled_test_cases : Test concurrent checker should pass stable window,,Test concurrent checker should pass window with varying drive strength,,Test concurrent checker should handle weak start and end events,,Test concurrent checker should fail unstable window,,Test concurrent checker should fail window with weak changes to opposite level,,Test concurrent checker should fail on unknown start event,,Test concurrent checker should fail on unknown end event in active window,,Test concurrent checker should fail on stable unknown window,,Test concurrent checker should handle back to back windows,,Test concurrent checker should ignore second of two overlapping windows,,Test concurrent checker should test one cycle windows,,Test concurrent checker with std_logic_vector input should pass unstable window if not enabled,,Test concurrent checker with std_logic input should pass unstable window if not enabled,,Test should handle reversed and or offset expressions,output path : d::/Programming/github/vunit/vunit/vhdl/check/vunit_out/tests/lib.tb_check_stable/,active python runner : true"} lib.tb_check_stable(test_fixture)   -L lib -L vunit_lib' failed
