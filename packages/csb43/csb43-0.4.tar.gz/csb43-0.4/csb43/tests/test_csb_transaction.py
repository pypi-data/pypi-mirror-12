...
class TestCsbTransaction(unittest.TestCase):
    ...
    def test_informationMode(self):
        ...
        self.assertEqual(self.t.informationMode, 3)
        ...
        for value in values:
            ...
            self.assertEqual(t.informationMode, value)
    ...
    def _test_reference1_mode12(self, t):
        ...
        for value in values:
            ...
            self.assertEqual(value.rstrip(), t.reference1)
    ...
    def test_reference1_mode3(self):
