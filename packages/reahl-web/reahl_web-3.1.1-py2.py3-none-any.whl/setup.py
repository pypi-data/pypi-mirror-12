...
setup(
    ...
    packages=['reahl', 'reahl.web', 'reahl.messages', 'reahl.web_dev', 'reahl.web.static', 'reahl.web.static.jquery', 'reahl.web_dev.appstructure', 'reahl.web_dev.advanced', 'reahl.web_dev.widgets', 'reahl.web_dev.inputandvalidation', 'reahl.web_dev.advanced.subresources'],
    py_modules=['setup'],
    include_package_data=True,
    package_data={'': ['*/LC_MESSAGES/*.mo']},
    namespace_packages=['reahl', 'reahl.messages'],
    install_requires=['reahl-component>=3.1,<3.2', 'ply>=3.8,<3.8.999', 'slimit>=0.8,<0.8.999', 'cssmin>=0.2,<0.2.999', 'BeautifulSoup4>=4.3,<4.3.999', 'webob>=1.4,<1.4.999', 'Babel>=2.1,<2.1.999'],
