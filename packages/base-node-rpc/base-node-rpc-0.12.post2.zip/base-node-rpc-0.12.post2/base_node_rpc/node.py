...
# ############################################################################
# [2015-10-13 12:28:10.664000] THIS FILE IS AUTOGENERATED - DO NOT EDIT!
# ############################################################################
import types
import pandas as pd
import numpy as np
...
class Proxy(ProxyBase):
    ...
    def package_name(self):
        command = np.dtype('uint8').type(self._CMD_PACKAGE_NAME)
        payload_size = 0
        payload_data = ''
    ...
    def display_name(self):
        command = np.dtype('uint8').type(self._CMD_DISPLAY_NAME)
        payload_size = 0
        payload_data = ''
