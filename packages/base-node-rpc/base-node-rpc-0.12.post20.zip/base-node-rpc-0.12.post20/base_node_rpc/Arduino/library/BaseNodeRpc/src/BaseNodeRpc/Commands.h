...
/* #########################################################################
 * [2015-12-15 12:35:22.794000] THIS FILE IS AUTOGENERATED - DO NOT EDIT!
 * ######################################################################### */
...
typedef struct __attribute__((packed)) {
  ...
  uint8_t bit_order;
  uint8_t data_mode;
} SpiBeginTransactionRequest;

typedef struct __attribute__((packed)) {
} SpiBeginTransactionResponse;

typedef struct __attribute__((packed)) {
} SpiEndTransactionRequest;

typedef struct __attribute__((packed)) {
} SpiEndTransactionResponse;
...
typedef struct __attribute__((packed)) {
  ...
  uint8_t data_mode;
  UInt8Array data;
} SpiTransferArrayRequest;

typedef struct __attribute__((packed)) {
  UInt8Array result;
} SpiTransferArrayResponse;
...
static const int CMD_SPI_BEGIN = 0x4fb;
static const int CMD_SET_SPI_BIT_ORDER = 0x4fc;
static const int CMD_SET_SPI_CLOCK_DIVIDER = 0x4fd;
static const int CMD_SET_SPI_DATA_MODE = 0x4fe;
static const int CMD_SPI_TRANSFER = 0x4ff;
static const int CMD_SPI_BEGIN_TRANSACTION = 0x500;
static const int CMD_SPI_END_TRANSACTION = 0x501;
static const int CMD_SPI_TRANSFER_ARRAY = 0x502;
