...
/* #########################################################################
 * [2015-12-15 12:35:20.884000] THIS FILE IS AUTOGENERATED - DO NOT EDIT!
 * ######################################################################### */
...
public:
  ...
  UInt8Array process_command(UInt8Array request_arr, UInt8Array buffer) {
    ...
    switch (command) {
        ...
        case CMD_SPI_BEGIN_TRANSACTION:
          {
            ...
            SpiBeginTransactionRequest &request = *(reinterpret_cast
                                          <SpiBeginTransactionRequest *>
                                          (&request_arr.data[2]));
    
    
            obj_.spi_begin_transaction(request.clock, request.bit_order, request.data_mode);
        ...
        case CMD_SPI_TRANSFER_ARRAY:
          {
            /* Cast buffer as request. */
    
            SpiTransferArrayRequest &request = *(reinterpret_cast
            ...
            request.data.data = (uint8_t *)((uint8_t *)&request + (unsigned int)request.data.data);
            SpiTransferArrayResponse response;

            response.result =
            obj_.spi_transfer_array(request.slave_select_pin, request.clock, request.bit_order, request.data_mode, request.data);
