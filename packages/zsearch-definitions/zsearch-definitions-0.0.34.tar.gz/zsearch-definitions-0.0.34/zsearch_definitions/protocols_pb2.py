...
_SUBPROTOCOL = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SUBPROTO_SYS_PUBLIC_LOCATION', index=37, number=192,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SUBPROTO_SYS_AS', index=38, number=193,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SUBPROTO_SYS_TAGS', index=39, number=194,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SUBPROTO_SYS_METADATA', index=40, number=195,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SUBPROTO_SYS_WHOIS', index=41, number=196,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SUBPROTO_SYS_USERDATA', index=42, number=197,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SUBPROTO_SYS_BLACKLIST', index=43, number=198,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SUBPROTO_SYS_ALEXA_RANK', index=44, number=199,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SUBPROTO_SYS_RESTRICTED_LOCATION', index=45, number=200,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SUBPROTO_SYS_VERSION', index=46, number=201,
      options=None,
      type=None),
  ],
  containing_type=None,
