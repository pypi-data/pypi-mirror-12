...
__all__ = ['AGNOptRefStarsClass', 'APASSClass', 'AstroWiseStandardStarsClass', 'BrightStarClass',
           'CatalogueConstants', 'GetVizierCat', 'NIRStandardStarsClass','ParseVisierCat',
           'SDSSClass', 'SimbadNameClass', 'SmithetalStandardStarsClass','StetsonJohnsonStandardStarsClass',
