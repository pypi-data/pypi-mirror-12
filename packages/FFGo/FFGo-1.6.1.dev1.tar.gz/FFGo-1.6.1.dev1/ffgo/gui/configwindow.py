...
relative to any custom scenery directories you may have installed.

This setting corresponds to the --fg-scenery fgfs option and is
documented at <http://wiki.flightgear.org/$FG_SCENERY>.
