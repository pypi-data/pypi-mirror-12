...
from commands import WORKSPACE_ID_ARG, BOXES_PATH_ARG, COMMENT_ARG, IMAGE_ARG, add_standard_argument
...
def execute_command(args, _unknown):
    ...
    boxes = Boxes(args.path if 'path' in args else os.getcwd(), session)
