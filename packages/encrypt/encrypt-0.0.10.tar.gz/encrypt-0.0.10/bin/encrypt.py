...
filemenu.add_command(label="New", command=passthrough)
filemenu.add_command(label="Open", command=passthrough)
filemenu.add_command(label="Save", command=passthrough)
filemenu.add_command(label="Save as...", command=passthrough)
filemenu.add_command(label="Close", command=passthrough)
filemenu.add_separator()
filemenu.add_command(label="Exit", command=passthrough)
...
editmenu.add_command(label="Cut", command=passthrough)
editmenu.add_command(label="Copy", command=passthrough)
editmenu.add_command(label="Paste", command=passthrough)
...
helpmenu.add_command(label="Help Index", command=passthrough)
...
output = StringVar()
output.set("v0.0.10. Python 2.7					@copyrights 2015 Imena Labs Ltd.")
