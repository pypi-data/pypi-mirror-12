...
class DebugServer(object):
    ...
    def startServer(self):
        ...
        registerMacro(lambda *vars: self.runCodeCommand(vars), "run", "\nrun script\n")
        registerMacro(lambda *vars: self.runCodeCommand(vars, debug = True), "rund", "\nrun script with debug\n")
        registerMacro(self.execCode, "exec", "\nexecute statement\n")
        registerMacro(lambda codestr: self.execCode(codestr, debug = True), "execd", "\nexecute statement with debug\n")
