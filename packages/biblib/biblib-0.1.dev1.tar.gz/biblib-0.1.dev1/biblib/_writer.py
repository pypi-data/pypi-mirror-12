...
def db_to_string(dbObj, encode=False):
    """
...
def db_to_file(dbObj, file, encode=False):
    """
...
def entry_to_string(entryObj, ckey=None, encode=False):
    """
