...
setup(
    ...
    description="A reusable app for cropping images easily and non-destructively in Django when using Amazon s3 storage for media files",
    long_description=open('README.rst').read(),
    author="original: jonasvp, modified by: seanslipetz ",
    author_email="seanslipetz@gmail.com",
    url="http://github.com/nerver/django-image-cropping-amazon-s3",
