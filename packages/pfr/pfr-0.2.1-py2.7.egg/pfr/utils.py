...
def getDoc(url):
    """Gets the PyQuery object for the entire document of HTML for the given
    URL using a GET request.

    Incorporates an exponential timeout starting with 1.5 seconds.

    :url: the absolute URL of the desired page.
    :returns: the PyQuery object for the entire page.
