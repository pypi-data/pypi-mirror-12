...
def strip_tags(html, valid_tags=[],remove_tags=['script','style']):
...
def filter_tags2(htmlstr):
    ...
    soup=strip_tags(s,valid_tags=['iframe','img'],remove_tags=['script','style'])
...
if __name__ == '__main__':
    str =u'''<iframe src="432432"></iframe>432432432432432432432432432<img src="432432432"/><font color=red></font>
