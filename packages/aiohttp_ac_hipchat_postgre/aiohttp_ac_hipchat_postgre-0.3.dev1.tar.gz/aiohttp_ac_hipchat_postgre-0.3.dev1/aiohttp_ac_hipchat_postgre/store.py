    ...
    def init_table(self):
        ...
        try:
            with (yield from self.postgres) as connection:
                ...
                log.info("Created the clients's data table")
