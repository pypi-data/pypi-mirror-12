...
from jaobi.models import ContentConsumption, Content
...
def update_themes_consolidation(cls, document):
    ...
    for theme in themes:
        ...
        yield consolidated.update(set__total=consolidated.total)
...
class OriginConsumption(Document):
...
signals.post_save.connect(OriginConsumption.update_consumption,
                          sender=ContentConsumption)

signals.post_bulk_insert.connect(
    OriginConsumption.bulk_update_consumption,
    sender=ContentConsumption)
