...
def _function_parse(func, args, kwargs):
    ...
    if func == sciexp2.data.io.find_files or \
       func == __function_wrap_find_files:
        ...
        warn = False
         ...
         func == sciexp2.data.io.extract_regex:
    ...
    if warn and not __function_arg_is_lazy(args) and \
       not __function_arg_is_lazy(kwargs):
        warnings.warn("Using lazy function evaluation with non-lazy arguments",
                      stacklevel=4)
