...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table('simplesjop_profile')

        # Adding field 'Category.path'
        db.add_column('simplesjop_category', 'path', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.send_create_signal('simplesjop', ['Profile'])

        # Deleting field 'Category.path'
        db.delete_column('simplesjop_category', 'path')
