...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('simplesjop_category', 'image', self.gf('filebrowser.fields.FileBrowseField')(max_length=200, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Category.image'
        db.delete_column('simplesjop_category', 'image')
