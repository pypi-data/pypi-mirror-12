...
# filebrowser imports
from changer.c5.filebrowser.settings import *
from changer.c5.filebrowser.functions import path_to_url, sort_by_attr, get_path, get_file, get_version_path, get_breadcrumbs, get_filterdate, get_settings_var, handle_file_upload, convert_filename
from changer.c5.filebrowser.templatetags.fb_tags import query_helper
from changer.c5.filebrowser.base import FileObject
...
def mkdir(request):
    ...
    from changer.c5.filebrowser.forms import MakeDirForm
...
def rename(request):
    ...
    from changer.c5.filebrowser.forms import RenameForm
