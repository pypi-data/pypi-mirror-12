...
livestatus_attribute_map = {
    'Host': {
        ...
        'comments': {
            ...
            'function': lambda item, req: [x.get_id() for x in item.comments],
            'datatype': list,
        },
        'comments_with_info': {
            'description': 'A list of the ids of all comments of this host with id, author and comment',
            'function': lambda item, req: [join_with_separators(req, str(x.get_id()), x.author, x.comment) for x in item.comments],  # REPAIRME MAYBE
            'datatype': list,
        },
        'contacts': {
        ...
        'downtimes': {
            ...
            'function': lambda item, req: [x.get_id() for x in item.downtimes],
            'datatype': list,
        },
        'downtimes_with_info': {
            'description': 'A list of the all scheduled downtimes of the host with id, author and comment',
            'function': lambda item, req: [join_with_separators(req, str(x.get_id()), x.author, x.comment) for x in item.downtimes],  # REPAIRME MAYBE
            'datatype': list,
    ...
    'Downtime': {
        ...
        'id': {
            ...
            'function': lambda item, req: item.get_id(),
            'datatype': int,
        },
        'is_service': {
