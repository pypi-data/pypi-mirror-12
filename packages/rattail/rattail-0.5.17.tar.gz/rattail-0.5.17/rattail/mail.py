...
def iter_emails(config):
    ...
    for module in config.getlist('rattail.mail', 'emails', default=[]):
        ...
        for name in dir(module):
            ...
            if isinstance(obj, type) and issubclass(obj, Email) and obj is not Email:
                yield obj
...
class Email(object):
    ...
    def make_message(self, data={}, attachments=[]):
        ...
        if attachments:
            ...
            # TODO: need to implement this at some point, obviously..
        ...
        if txt_template and html_template:
            ...
            raise NotImplementedError # TODO: no html or txt templates found
