...
from flask import redirect, request, url_for, session, jsonify, abort
...
def contact_page(view, **kwargs):
    ...
    @nav_menu(kwargs.get("menu", "Contact"),
              ...
              is_class_=False,
              module_=view.__module__,
              class_=view.__name__
    ...
    def contact_page(self):
        ...
        if request.method == "POST":
            ...
            return self.render(view_template_=template_page % "contact_page")
