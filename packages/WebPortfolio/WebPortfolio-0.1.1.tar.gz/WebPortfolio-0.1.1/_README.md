...
#### * MarcoPolo.render(data={}, view_template_=None, layout_=None)

This is the meat of MarcoPolo, 

* **data** : A dict of data to be passed to the template

* **view_template_** : The file path of the template to display. By default the template will map the view method. 
