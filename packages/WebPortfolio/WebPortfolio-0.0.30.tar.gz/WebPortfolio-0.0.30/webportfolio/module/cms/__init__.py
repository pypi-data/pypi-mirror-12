...
from webportfolio.decorators import (render_as_template, render_as_json,
                                     render_as_xml, nav_menu, with_user_roles,
                                     login_required, no_login_required, extends)
...
def post(view, **kwargs):
    ...
    nav_menu_prop = {"class_": view.__name__, "module_": view.__module__}
