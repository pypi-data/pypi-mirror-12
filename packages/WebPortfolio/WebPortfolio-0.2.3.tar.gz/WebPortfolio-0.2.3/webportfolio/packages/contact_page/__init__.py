...
from webportfolio import (WebPortfolio, route, flash_error, flash_success, register_package)
...
def contact_page(view, **kwargs):
    ...
    template_dir = kwargs.pop("template_dir", "WebPortfolio/Package/ContactPage")
