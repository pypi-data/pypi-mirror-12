...
org.nfrac.comportex.demos.isolated_1d.world_transform = (function org$nfrac$comportex$demos$isolated_1d$world_transform(p__64152){
var map__64156 = p__64152;
var map__64156__$1 = ((((!((map__64156 == null)))?((((map__64156.cljs$lang$protocol_mask$partition0$ & (64))) || (map__64156.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__64156):map__64156);
var input = map__64156__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64156__$1,cljs.core.cst$kw$id);
var values = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64156__$1,cljs.core.cst$kw$values);
var index = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64156__$1,cljs.core.cst$kw$index);
...
var vec__64158 = clojure.test.check.random.split(cljs.core.cst$kw$org$nfrac$comportex$demos$isolated_DASH_1d_SLASH_rng.cljs$core$IFn$_invoke$arity$1(cljs.core.meta(input)));
var rng = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64158,(0),null);
var rng_STAR_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64158,(1),null);
...
var args64159 = [];
var len__5740__auto___64162 = arguments.length;
var i__5741__auto___64163 = (0);
while(true){
if((i__5741__auto___64163 < len__5740__auto___64162)){
args64159.push((arguments[i__5741__auto___64163]));

var G__64164 = (i__5741__auto___64163 + (1));
i__5741__auto___64163 = G__64164;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args64159.length)].join('')));
