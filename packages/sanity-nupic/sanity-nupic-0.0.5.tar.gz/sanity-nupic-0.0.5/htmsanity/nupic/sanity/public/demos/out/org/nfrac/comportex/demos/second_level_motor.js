...
return (function (p1__67002_SHARP_){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2(cljs.core.vec,p1__67002_SHARP_);
});})(text))
,cljs.core.mapv.cljs$core$IFn$_invoke$arity$2(((function (text){
return (function (p1__67001_SHARP_){
return clojure.string.split.cljs$core$IFn$_invoke$arity$2(p1__67001_SHARP_,/[^\w']+/);
});})(text))
...
org.nfrac.comportex.demos.second_level_motor.next_position = (function org$nfrac$comportex$demos$second_level_motor$next_position(p__67003,action){
var vec__67005 = p__67003;
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67005,(0),null);
var j = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67005,(1),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67005,(2),null);
...
var args67006 = [];
var len__5740__auto___67009 = arguments.length;
var i__5741__auto___67010 = (0);
while(true){
if((i__5741__auto___67010 < len__5740__auto___67009)){
args67006.push((arguments[i__5741__auto___67010]));

var G__67011 = (i__5741__auto___67010 + (1));
i__5741__auto___67010 = G__67011;
continue;
} else {
}
break;
...
var c__35961__auto___67087 = cljs.core.async.chan.cljs$core$IFn$_invoke$arity$1((1));
cljs.core.async.impl.dispatch.run(((function (c__35961__auto___67087){
return (function (){
var f__35962__auto__ = (function (){var switch__35847__auto__ = ((function (c__35961__auto___67087){
return (function (state_67066){
var state_val_67067 = (state_67066[(1)]);
if((state_val_67067 === (1))){
var state_67066__$1 = state_67066;
var statearr_67068_67088 = state_67066__$1;
(statearr_67068_67088[(2)] = null);

(statearr_67068_67088[(1)] = (2));
...
var state_67066__$1 = state_67066;
return cljs.core.async.impl.ioc_helpers.take_BANG_(state_67066__$1,(4),control_c);
} else {
...
var inst_67052 = (state_67066[(7)]);
var inst_67052__$1 = (state_67066[(2)]);
var state_67066__$1 = (function (){var statearr_67069 = state_67066;
(statearr_67069[(7)] = inst_67052__$1);

return statearr_67069;
})();
if(cljs.core.truth_(inst_67052__$1)){
var statearr_67070_67089 = state_67066__$1;
(statearr_67070_67089[(1)] = (5));

} else {
var statearr_67071_67090 = state_67066__$1;
(statearr_67071_67090[(1)] = (6));
...
var state_67066__$1 = state_67066;
return cljs.core.async.impl.ioc_helpers.take_BANG_(state_67066__$1,(8),world_c);
} else {
if((state_val_67067 === (6))){
var state_67066__$1 = state_67066;
var statearr_67072_67091 = state_67066__$1;
(statearr_67072_67091[(2)] = null);

(statearr_67072_67091[(1)] = (7));


return cljs.core.cst$kw$recur;
} else {
if((state_val_67067 === (7))){
var inst_67062 = (state_67066[(2)]);
var state_67066__$1 = state_67066;
var statearr_67073_67092 = state_67066__$1;
(statearr_67073_67092[(2)] = inst_67062);

(statearr_67073_67092[(1)] = (3));
...
var inst_67052 = (state_67066[(7)]);
var inst_67055 = (state_67066[(2)]);
var inst_67056 = (inst_67052.cljs$core$IFn$_invoke$arity$1 ? inst_67052.cljs$core$IFn$_invoke$arity$1(inst_67055) : inst_67052.call(null,inst_67055));
var state_67066__$1 = state_67066;
return cljs.core.async.impl.ioc_helpers.put_BANG_(state_67066__$1,(9),world_c,inst_67056);
} else {
if((state_val_67067 === (9))){
var inst_67058 = (state_67066[(2)]);
var state_67066__$1 = (function (){var statearr_67074 = state_67066;
(statearr_67074[(8)] = inst_67058);

return statearr_67074;
})();
var statearr_67075_67093 = state_67066__$1;
(statearr_67075_67093[(2)] = null);

(statearr_67075_67093[(1)] = (2));
...
});})(c__35961__auto___67087))
;
return ((function (switch__35847__auto__,c__35961__auto___67087){
return (function() {
...
var statearr_67079 = [null,null,null,null,null,null,null,null,null];
(statearr_67079[(0)] = org$nfrac$comportex$demos$second_level_motor$htm_step_with_action_selection_$_state_machine__35848__auto__);

(statearr_67079[(1)] = (1));

return statearr_67079;
});
var org$nfrac$comportex$demos$second_level_motor$htm_step_with_action_selection_$_state_machine__35848__auto____1 = (function (state_67066){
while(true){
var ret_value__35849__auto__ = (function (){try{while(true){
var result__35850__auto__ = switch__35847__auto__(state_67066);
...
}catch (e67080){if((e67080 instanceof Object)){
var ex__35851__auto__ = e67080;
var statearr_67081_67094 = state_67066;
(statearr_67081_67094[(5)] = ex__35851__auto__);


cljs.core.async.impl.ioc_helpers.process_exception(state_67066);
...
var G__67095 = state_67066;
state_67066 = G__67095;
continue;
} else {
...
org$nfrac$comportex$demos$second_level_motor$htm_step_with_action_selection_$_state_machine__35848__auto__ = function(state_67066){
...
case 1:
return org$nfrac$comportex$demos$second_level_motor$htm_step_with_action_selection_$_state_machine__35848__auto____1.call(this,state_67066);
}
...
;})(switch__35847__auto__,c__35961__auto___67087))
})();
var state__35963__auto__ = (function (){var statearr_67082 = (f__35962__auto__.cljs$core$IFn$_invoke$arity$0 ? f__35962__auto__.cljs$core$IFn$_invoke$arity$0() : f__35962__auto__.call(null));
(statearr_67082[cljs.core.async.impl.ioc_helpers.USER_START_IDX] = c__35961__auto___67087);
...
var vec__67083 = cljs.core.cst$kw$position.cljs$core$IFn$_invoke$arity$1(inval);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67083,(0),null);
var j = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67083,(1),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67083,(2),null);
...
var word_burst_QMARK_ = (function (){var G__67084 = cljs.core.cst$kw$word_DASH_bursting_QMARK_.cljs$core$IFn$_invoke$arity$1(cljs.core.cst$kw$action.cljs$core$IFn$_invoke$arity$1(inval));
if((k > (0))){
var or__4682__auto__ = G__67084;
...
var sent_burst_QMARK_ = (function (){var G__67085 = cljs.core.cst$kw$sentence_DASH_bursting_QMARK_.cljs$core$IFn$_invoke$arity$1(cljs.core.cst$kw$action.cljs$core$IFn$_invoke$arity$1(inval));
if((k > (0))){
var or__4682__auto__ = G__67085;
if(cljs.core.truth_(or__4682__auto__)){
return or__4682__auto__;
} else {
return (r0_burst_frac >= 0.5);
...
var new_inval_67096 = org.nfrac.comportex.demos.second_level_motor.apply_action(inval_with_action);
cljs.core.async.put_BANG_.cljs$core$IFn$_invoke$arity$2(world_c,new_inval_67096);

var G__67086 = htm_a;
var G__67086__$1 = org.nfrac.comportex.protocols.htm_sense(G__67086,inval_with_action,cljs.core.cst$kw$motor)
;
var G__67086__$2 = org.nfrac.comportex.protocols.htm_depolarise(G__67086__$1)
;
if((end_of_word_QMARK_) && (cljs.core.not(word_burst_QMARK_))){
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$4(G__67086__$2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$regions,cljs.core.cst$kw$rgn_DASH_0], null),org.nfrac.comportex.protocols.break$,cljs.core.cst$kw$tm);
} else {
return G__67086__$2;
}
});
