...
org.nfrac.comportex.demos.sensorimotor_1d.fields = cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__5454__auto__ = (function org$nfrac$comportex$demos$sensorimotor_1d$iter__64134(s__64135){
return (new cljs.core.LazySeq(null,(function (){
var s__64135__$1 = s__64135;
while(true){
var temp__4653__auto__ = cljs.core.seq(s__64135__$1);
if(temp__4653__auto__){
var s__64135__$2 = temp__4653__auto__;
if(cljs.core.chunked_seq_QMARK_(s__64135__$2)){
var c__5452__auto__ = cljs.core.chunk_first(s__64135__$2);
var size__5453__auto__ = cljs.core.count(c__5452__auto__);
var b__64137 = cljs.core.chunk_buffer(size__5453__auto__);
if((function (){var i__64136 = (0);
while(true){
if((i__64136 < size__5453__auto__)){
var k = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__5452__auto__,i__64136);
cljs.core.chunk_append(b__64137,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.mapv.cljs$core$IFn$_invoke$arity$2(cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.keyword,cljs.core.str),cljs.core.name(k))], null));
...
var vec__64142 = clojure.test.check.random.split(cljs.core.cst$kw$org$nfrac$comportex$demos$sensorimotor_DASH_1d_SLASH_rng.cljs$core$IFn$_invoke$arity$1(cljs.core.meta(m)));
var rng = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64142,(0),null);
var rng_STAR_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64142,(1),null);
...
var args64143 = [];
var len__5740__auto___64146 = arguments.length;
var i__5741__auto___64147 = (0);
while(true){
if((i__5741__auto___64147 < len__5740__auto___64146)){
args64143.push((arguments[i__5741__auto___64147]));

var G__64148 = (i__5741__auto___64147 + (1));
i__5741__auto___64147 = G__64148;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args64143.length)].join('')));
