...
org.nfrac.comportex.demos.q_learning_1d.column__GT_signal = cljs.core.zipmap(cljs.core.range.cljs$core$IFn$_invoke$arity$0(),(function (){var iter__5454__auto__ = (function org$nfrac$comportex$demos$q_learning_1d$iter__65106(s__65107){
return (new cljs.core.LazySeq(null,(function (){
var s__65107__$1 = s__65107;
while(true){
var temp__4653__auto__ = cljs.core.seq(s__65107__$1);
if(temp__4653__auto__){
var xs__5201__auto__ = temp__4653__auto__;
var direction = cljs.core.first(xs__5201__auto__);
var iterys__5450__auto__ = ((function (s__65107__$1,direction,xs__5201__auto__,temp__4653__auto__){
return (function org$nfrac$comportex$demos$q_learning_1d$iter__65106_$_iter__65108(s__65109){
return (new cljs.core.LazySeq(null,((function (s__65107__$1,direction,xs__5201__auto__,temp__4653__auto__){
return (function (){
var s__65109__$1 = s__65109;
while(true){
var temp__4653__auto____$1 = cljs.core.seq(s__65109__$1);
if(temp__4653__auto____$1){
var s__65109__$2 = temp__4653__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__65109__$2)){
var c__5452__auto__ = cljs.core.chunk_first(s__65109__$2);
var size__5453__auto__ = cljs.core.count(c__5452__auto__);
var b__65111 = cljs.core.chunk_buffer(size__5453__auto__);
if((function (){var i__65110 = (0);
while(true){
if((i__65110 < size__5453__auto__)){
var influence = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__5452__auto__,i__65110);
cljs.core.chunk_append(b__65111,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [direction,influence], null));

var G__65117 = (i__65110 + (1));
i__65110 = G__65117;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__65111),org$nfrac$comportex$demos$q_learning_1d$iter__65106_$_iter__65108(cljs.core.chunk_rest(s__65109__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__65111),null);
}
} else {
var influence = cljs.core.first(s__65109__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [direction,influence], null),org$nfrac$comportex$demos$q_learning_1d$iter__65106_$_iter__65108(cljs.core.rest(s__65109__$2)));
}
} else {
return null;
}
...
});})(s__65107__$1,direction,xs__5201__auto__,temp__4653__auto__))
,null,null));
});})(s__65107__$1,direction,xs__5201__auto__,temp__4653__auto__))
;
var fs__5451__auto__ = cljs.core.seq(iterys__5450__auto__(cljs.core.repeat.cljs$core$IFn$_invoke$arity$2((15),1.0)));
if(fs__5451__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__5451__auto__,org$nfrac$comportex$demos$q_learning_1d$iter__65106(cljs.core.rest(s__65107__$1)));
} else {
var G__65118 = cljs.core.rest(s__65107__$1);
s__65107__$1 = G__65118;
continue;
}
} else {
return null;
...
return iter__5454__auto__(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$left,cljs.core.cst$kw$right], null));
})());
...
var G__65126 = cljs.core.key(cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.max_key,cljs.core.val,cljs.core.shuffle(cljs.core.persistent_BANG_(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(((function (alyr,acols,signals){
return (function (m,p__65127){
var vec__65128 = p__65127;
var motion = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65128,(0),null);
var influence = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65128,(1),null);
...
return (org.nfrac.comportex.demos.q_learning_1d.direction__GT_action.cljs$core$IFn$_invoke$arity$1 ? org.nfrac.comportex.demos.q_learning_1d.direction__GT_action.cljs$core$IFn$_invoke$arity$1(G__65126) : org.nfrac.comportex.demos.q_learning_1d.direction__GT_action.call(null,G__65126));
});
...
var y__5021__auto__ = (cljs.core.count(org.nfrac.comportex.demos.q_learning_1d.surface) - (1));
...
return cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p__65131){
var vec__65132 = p__65131;
var in_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65132,(0),null);
var p = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65132,(1),null);
...
return cljs.core.keep.cljs$core$IFn$_invoke$arity$2((function (p__65135){
var vec__65136 = p__65135;
var in_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65136,(0),null);
var p = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65136,(1),null);
...
var map__65139 = org.nfrac.comportex.protocols.params(lyr);
var map__65139__$1 = ((((!((map__65139 == null)))?((((map__65139.cljs$lang$protocol_mask$partition0$ & (64))) || (map__65139.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__65139):map__65139);
var ff_perm_init_lo = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65139__$1,cljs.core.cst$kw$ff_DASH_perm_DASH_init_DASH_lo);
var q_alpha = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65139__$1,cljs.core.cst$kw$q_DASH_alpha);
var q_discount = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65139__$1,cljs.core.cst$kw$q_DASH_discount);
var ff_bits = (function (){var or__4682__auto__ = cljs.core.cst$kw$in_DASH_ff_DASH_bits.cljs$core$IFn$_invoke$arity$1(cljs.core.cst$kw$state.cljs$core$IFn$_invoke$arity$1(lyr));
...
var prev_ff_bits = (function (){var or__4682__auto__ = cljs.core.cst$kw$in_DASH_ff_DASH_bits.cljs$core$IFn$_invoke$arity$1(cljs.core.cst$kw$state.cljs$core$IFn$_invoke$arity$1(prev_lyr));
if(cljs.core.truth_(or__4682__auto__)){
return or__4682__auto__;
} else {
return cljs.core.PersistentHashSet.EMPTY;
...
var aperms = cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(((function (prev_lyr,map__65139,map__65139__$1,ff_perm_init_lo,q_alpha,q_discount,ff_bits,acols,prev_ff_bits,prev_acols,psg){
return (function (col){
...
});})(prev_lyr,map__65139,map__65139__$1,ff_perm_init_lo,q_alpha,q_discount,ff_bits,acols,prev_ff_bits,prev_acols,psg))
...
var seg_updates = cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (prev_lyr,map__65139,map__65139__$1,ff_perm_init_lo,q_alpha,q_discount,ff_bits,acols,prev_ff_bits,prev_acols,psg,aperms,Q_est,Q_old,learn_value,adjust,op){
return (function (col){
...
});})(prev_lyr,map__65139,map__65139__$1,ff_perm_init_lo,q_alpha,q_discount,ff_bits,acols,prev_ff_bits,prev_acols,psg,aperms,Q_est,Q_old,learn_value,adjust,op))
,prev_acols);
...
var msensor = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$action,cljs.core.cst$kw$dx], null),org.nfrac.comportex.encoders.linear_encoder(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(100)], null),(30),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(-1),(1)], null))], null);
...
var new_inval_65141 = org.nfrac.comportex.demos.q_learning_1d.apply_action(inval_with_action);
cljs.core.async.put_BANG_.cljs$core$IFn$_invoke$arity$2(world_c,new_inval_65141);
