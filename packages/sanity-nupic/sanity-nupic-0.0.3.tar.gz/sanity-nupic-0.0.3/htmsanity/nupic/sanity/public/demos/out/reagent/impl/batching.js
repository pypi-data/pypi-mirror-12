...
var c_40021 = (a[i]);
if(cljs.core.truth_((c_40021["cljsIsDirty"]))){
(c_40021["forceUpdate"])();
} else {
}
...
var G__40024 = ((function (this$){
return (function (){
return this$.run_queue();
});})(this$))
;
return (reagent.impl.batching.next_tick.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.batching.next_tick.cljs$core$IFn$_invoke$arity$1(G__40024) : reagent.impl.batching.next_tick.call(null,G__40024));
}
});
...
var G__40026 = c;
var G__40026__$1 = (((G__40026 == null))?null:(G__40026["props"]));
if((G__40026__$1 == null)){
return null;
} else {
return (G__40026__$1["argv"]);
}
});
...
var G__40028_40029 = (c["cljsRatom"]);
if((G__40028_40029 == null)){
} else {
reagent.ratom.dispose_BANG_(G__40028_40029);
}
