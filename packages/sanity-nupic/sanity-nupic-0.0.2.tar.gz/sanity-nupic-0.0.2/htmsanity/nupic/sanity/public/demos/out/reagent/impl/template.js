...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__5280__auto__,writer__5281__auto__,opt__5282__auto__){
return cljs.core._write(writer__5281__auto__,"reagent.impl.template/NativeWrapper");
});
...
var or__4682__auto__ = reagent.impl.template.named_QMARK_(x);
...
var or__4682__auto__ = reagent.impl.template.hiccup_tag_QMARK_(x);
if(cljs.core.truth_(or__4682__auto__)){
return or__4682__auto__;
} else {
...
var G__40112 = o;
(G__40112[reagent.impl.template.cached_prop_name(k)] = reagent$impl$template$convert_prop_value(v));
...
return (function() { 
var G__40113__delegate = function (args){
...
while (G__40114__i < G__40114__a.length) {G__40114__a[G__40114__i] = arguments[G__40114__i + 0]; ++G__40114__i;}
  args = new cljs.core.IndexedSeq(G__40114__a,0);
} 
return G__40113__delegate.call(this,args);};
G__40113.cljs$lang$maxFixedArity = 0;
G__40113.cljs$lang$applyTo = (function (arglist__40115){
var args = cljs.core.seq(arglist__40115);
return G__40113__delegate(args);
});
...
var old_40116 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_(old_40116))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_40116)].join(''):class$));
} else {
}
...
if(cljs.core.truth_((function (){var and__4670__auto__ = (jsprops["hasOwnProperty"])("onChange");
...
var G__40119 = jsprops;
(G__40119["defaultValue"] = value);

(G__40119["onChange"] = ((function (G__40119,v,value,on_change){
return (function (p1__40117_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__40117_SHARP_);
});})(G__40119,v,value,on_change))
);
...
var vec__40121 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40121,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40121,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40121,(2),null);
...
var temp__4655__auto__ = (function (){var G__40123 = cljs.core.meta(v);
if((G__40123 == null)){
return null;
} else {
return reagent.impl.template.get_key(G__40123);
}
})();
if((temp__4655__auto__ == null)){
...
var jsprops = {"argv": v};
var G__40125_40126 = v;
var G__40125_40127__$1 = (((G__40125_40126 == null))?null:reagent.impl.template.key_from_vec(G__40125_40126));
if((G__40125_40127__$1 == null)){
} else {
(jsprops["key"] = G__40125_40127__$1);
}
...
var temp__4655__auto__ = reagent.impl.template.obj_get(reagent.impl.template.tag_name_cache,cljs.core.name(x));
if((temp__4655__auto__ == null)){
...
var temp__4653__auto__ = reagent.impl.template.cached_parse(tag);
if(cljs.core.truth_(temp__4653__auto__)){
var parsed = temp__4653__auto__;
...
var G__40131 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input,argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__40131) : reagent.impl.template.as_element.call(null,G__40131));
} else {
var p = (function (){var temp__4655__auto__ = (function (){var G__40132 = cljs.core.meta(argv);
if((G__40132 == null)){
return null;
} else {
return reagent.impl.template.get_key(G__40132);
}
})();
if((temp__4655__auto__ == null)){
return jsprops;
...
var G__40133 = (((jsprops == null))?{}:jsprops);
(G__40133["key"] = key);
...
var temp__4655__auto__ = reagent.impl.template.native_element(tag,v);
if((temp__4655__auto__ == null)){
return reagent.impl.template.reag_element(tag,v);
} else {
var ne = temp__4655__auto__;
return ne;
}
});
...
var n__5585__auto___40134 = a.length;
var i_40135 = (0);
while(true){
if((i_40135 < n__5585__auto___40134)){
(a[i_40135] = reagent.impl.template.as_element((a[i_40135])));

var G__40136 = (i_40135 + (1));
i_40135 = G__40136;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__5585__auto___40137 = a.length;
var i_40138 = (0);
while(true){
if((i_40138 < n__5585__auto___40137)){
var val_40139 = (a[i_40138]);
if((cljs.core.vector_QMARK_(val_40139)) && ((reagent.impl.template.key_from_vec(val_40139) == null))){
(o["no-key"] = true);
} else {
}

(a[i_40138] = reagent.impl.template.as_element(val_40139));

var G__40140 = (i_40138 + (1));
i_40138 = G__40140;
continue;
} else {
}
...
var G__40142 = (cljs.core.count(argv) - first_child);
switch (G__40142) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__40142){
