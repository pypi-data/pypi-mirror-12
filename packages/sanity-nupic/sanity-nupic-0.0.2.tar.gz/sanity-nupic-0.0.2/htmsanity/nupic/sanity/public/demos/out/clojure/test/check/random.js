...
var x__5337__auto__ = (((rng == null))?null:rng);
var m__5338__auto__ = (clojure.test.check.random.rand_long[goog.typeOf(x__5337__auto__)]);
if(!((m__5338__auto__ == null))){
return (m__5338__auto__.cljs$core$IFn$_invoke$arity$1 ? m__5338__auto__.cljs$core$IFn$_invoke$arity$1(rng) : m__5338__auto__.call(null,rng));
} else {
var m__5338__auto____$1 = (clojure.test.check.random.rand_long["_"]);
if(!((m__5338__auto____$1 == null))){
return (m__5338__auto____$1.cljs$core$IFn$_invoke$arity$1 ? m__5338__auto____$1.cljs$core$IFn$_invoke$arity$1(rng) : m__5338__auto____$1.call(null,rng));
} else {
...
var x__5337__auto__ = (((rng == null))?null:rng);
var m__5338__auto__ = (clojure.test.check.random.rand_double[goog.typeOf(x__5337__auto__)]);
if(!((m__5338__auto__ == null))){
return (m__5338__auto__.cljs$core$IFn$_invoke$arity$1 ? m__5338__auto__.cljs$core$IFn$_invoke$arity$1(rng) : m__5338__auto__.call(null,rng));
} else {
var m__5338__auto____$1 = (clojure.test.check.random.rand_double["_"]);
if(!((m__5338__auto____$1 == null))){
return (m__5338__auto____$1.cljs$core$IFn$_invoke$arity$1 ? m__5338__auto____$1.cljs$core$IFn$_invoke$arity$1(rng) : m__5338__auto____$1.call(null,rng));
} else {
...
var x__5337__auto__ = (((rng == null))?null:rng);
var m__5338__auto__ = (clojure.test.check.random.split[goog.typeOf(x__5337__auto__)]);
if(!((m__5338__auto__ == null))){
return (m__5338__auto__.cljs$core$IFn$_invoke$arity$1 ? m__5338__auto__.cljs$core$IFn$_invoke$arity$1(rng) : m__5338__auto__.call(null,rng));
} else {
var m__5338__auto____$1 = (clojure.test.check.random.split["_"]);
if(!((m__5338__auto____$1 == null))){
return (m__5338__auto____$1.cljs$core$IFn$_invoke$arity$1 ? m__5338__auto____$1.cljs$core$IFn$_invoke$arity$1(rng) : m__5338__auto____$1.call(null,rng));
} else {
...
var x__5337__auto__ = (((rng == null))?null:rng);
var m__5338__auto__ = (clojure.test.check.random.split_n[goog.typeOf(x__5337__auto__)]);
if(!((m__5338__auto__ == null))){
return (m__5338__auto__.cljs$core$IFn$_invoke$arity$2 ? m__5338__auto__.cljs$core$IFn$_invoke$arity$2(rng,n) : m__5338__auto__.call(null,rng,n));
} else {
var m__5338__auto____$1 = (clojure.test.check.random.split_n["_"]);
if(!((m__5338__auto____$1 == null))){
return (m__5338__auto____$1.cljs$core$IFn$_invoke$arity$2 ? m__5338__auto____$1.cljs$core$IFn$_invoke$arity$2(rng,n) : m__5338__auto____$1.call(null,rng,n));
} else {
...
var G__34384 = z;
if(((24) > (function (){var G__34385 = clojure.test.check.random.bxoubsr(z,(1));
return (clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1 ? clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1(G__34385) : clojure.test.check.random.longs.bit_count.call(null,G__34385));
})())){
return clojure.test.check.random.longs.bit_xor(G__34384,clojure.test.check.random.mix_gamma_const_3);
} else {
return G__34384;
}
});
...
var G__34388 = state_SINGLEQUOTE__SINGLEQUOTE_;
var G__34389 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(ret,new_rng);
state__$1 = G__34388;
ret = G__34389;
continue;
}
...
clojure.test.check.random.JavaUtilSplittableRandom.cljs$lang$ctorPrWriter = (function (this__5280__auto__,writer__5281__auto__,opt__5282__auto__){
return cljs.core._write(writer__5281__auto__,"clojure.test.check.random/JavaUtilSplittableRandom");
});
...
return (new clojure.test.check.random.JavaUtilSplittableRandom(clojure.test.check.random.golden_gamma,(function (){var or__4682__auto__ = clojure.test.check.random.longs.__GT_long(seed);
...
clojure.test.check.random.next_rng = (function (){var a = (function (){var G__34390 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$state,clojure.test.check.random.make_java_util_splittable_random((new Date()).valueOf())], null);
return (cljs.core.atom.cljs$core$IFn$_invoke$arity$1 ? cljs.core.atom.cljs$core$IFn$_invoke$arity$1(G__34390) : cljs.core.atom.call(null,G__34390));
})();
return ((function (a){
return (function (){
...
var map__34392__$1 = ((((!((map__34392 == null)))?((((map__34392.cljs$lang$protocol_mask$partition0$ & (64))) || (map__34392.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__34392):map__34392);
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34392__$1,cljs.core.cst$kw$state);
var vec__34394 = clojure.test.check.random.split(state);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34394,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34394,(1),null);
...
var args34395 = [];
var len__5740__auto___34398 = arguments.length;
var i__5741__auto___34399 = (0);
while(true){
if((i__5741__auto___34399 < len__5740__auto___34398)){
args34395.push((arguments[i__5741__auto___34399]));

var G__34400 = (i__5741__auto___34399 + (1));
i__5741__auto___34399 = G__34400;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args34395.length)].join('')));
