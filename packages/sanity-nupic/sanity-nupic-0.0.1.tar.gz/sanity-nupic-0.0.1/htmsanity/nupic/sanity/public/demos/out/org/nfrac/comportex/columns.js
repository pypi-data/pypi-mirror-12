...
var vec__34702 = org.nfrac.comportex.protocols.dimensions(topo);
var cw = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34702,(0),null);
var ch = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34702,(1),null);
var vec__34703 = org.nfrac.comportex.protocols.dimensions(itopo);
var iw = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34703,(0),null);
var ih = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34703,(1),null);
if(global_QMARK_){
var n_syns = org.nfrac.comportex.util.round.cljs$core$IFn$_invoke$arity$1((frac * input_size));
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2(((function (n_syns,p_hi,p_lo,global_QMARK_,radius,frac,input_size,n_cols,one_d_QMARK_,vec__34702,cw,ch,vec__34703,iw,ih){
return (function (col_rng){
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1(((function (n_syns,p_hi,p_lo,global_QMARK_,radius,frac,input_size,n_cols,one_d_QMARK_,vec__34702,cw,ch,vec__34703,iw,ih){
return (function (rng__$1){
var vec__34704 = clojure.test.check.random.split(rng__$1);
var rng1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34704,(0),null);
var rng2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34704,(1),null);
...
});})(n_syns,p_hi,p_lo,global_QMARK_,radius,frac,input_size,n_cols,one_d_QMARK_,vec__34702,cw,ch,vec__34703,iw,ih))
),clojure.test.check.random.split_n(col_rng,n_syns));
});})(n_syns,p_hi,p_lo,global_QMARK_,radius,frac,input_size,n_cols,one_d_QMARK_,vec__34702,cw,ch,vec__34703,iw,ih))
,clojure.test.check.random.split_n(rng,n_cols));
} else {
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$3(((function (p_hi,p_lo,global_QMARK_,radius,frac,input_size,n_cols,one_d_QMARK_,vec__34702,cw,ch,vec__34703,iw,ih){
return (function (col,col_rng){
var focus_i = ((one_d_QMARK_)?org.nfrac.comportex.util.round.cljs$core$IFn$_invoke$arity$1((input_size * (col / n_cols))):(function (){var vec__34706 = org.nfrac.comportex.protocols.coordinates_of_index(topo,col);
var cx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34706,(0),null);
var cy = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34706,(1),null);
...
var vec__34705 = clojure.test.check.random.split(col_rng);
var rng1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34705,(0),null);
var rng2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34705,(1),null);
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$3(((function (focus_i,all_ids,n,vec__34705,rng1,rng2,ids,p_hi,p_lo,global_QMARK_,radius,frac,input_size,n_cols,one_d_QMARK_,vec__34702,cw,ch,vec__34703,iw,ih){
...
});})(focus_i,all_ids,n,vec__34705,rng1,rng2,ids,p_hi,p_lo,global_QMARK_,radius,frac,input_size,n_cols,one_d_QMARK_,vec__34702,cw,ch,vec__34703,iw,ih))
,ids,clojure.test.check.random.split_n(rng2,cljs.core.count(ids))));
});})(p_hi,p_lo,global_QMARK_,radius,frac,input_size,n_cols,one_d_QMARK_,vec__34702,cw,ch,vec__34703,iw,ih))
...
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34708,(1),null);
...
var G__34709 = ids;
var G__34710 = cljs.core.next(on_bits);
ids = G__34709;
on_bits = G__34710;
continue;
} else {
...
if((dist < radius)){
var G__34711 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(ids,id);
var G__34712 = cljs.core.next(on_bits);
ids = G__34711;
on_bits = G__34712;
continue;
} else {
var G__34713 = ids;
var G__34714 = cljs.core.next(on_bits);
ids = G__34713;
on_bits = G__34714;
continue;
}
...
return (p1__34715_SHARP_ * decay);
});})(d,decay))
,v),is,((function (d,decay){
return (function (p1__34716_SHARP_){
return (p1__34716_SHARP_ + d);
});})(d,decay))
);
});
