...
org.nfrac.comportex.demos.coordinates_2d.clamp_vec = (function org$nfrac$comportex$demos$coordinates_2d$clamp_vec(p__65694,max_mag){
var vec__65697 = p__65694;
var vx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65697,(0),null);
var vy = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65697,(1),null);
var mag = (function (){var G__65698 = ((vx * vx) + (vy * vy));
return Math.sqrt(G__65698);
})();
...
org.nfrac.comportex.demos.coordinates_2d.input_transform = (function org$nfrac$comportex$demos$coordinates_2d$input_transform(p__65699){
var map__65703 = p__65699;
var map__65703__$1 = ((((!((map__65703 == null)))?((((map__65703.cljs$lang$protocol_mask$partition0$ & (64))) || (map__65703.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__65703):map__65703);
var x = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65703__$1,cljs.core.cst$kw$x);
var y = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65703__$1,cljs.core.cst$kw$y);
var vx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65703__$1,cljs.core.cst$kw$vx);
var vy = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65703__$1,cljs.core.cst$kw$vy);
var ax = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65703__$1,cljs.core.cst$kw$ax);
var ay = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65703__$1,cljs.core.cst$kw$ay);
var vec__65705 = org.nfrac.comportex.demos.coordinates_2d.clamp_vec(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(vx + ax),(vy + ay)], null),org.nfrac.comportex.demos.coordinates_2d.max_vel);
var vx2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65705,(0),null);
var vy2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65705,(1),null);
var x2 = (x + vx);
var y2 = (y + vy);
...
var args65706 = [];
var len__5740__auto___65709 = arguments.length;
var i__5741__auto___65710 = (0);
while(true){
if((i__5741__auto___65710 < len__5740__auto___65709)){
args65706.push((arguments[i__5741__auto___65710]));

var G__65711 = (i__5741__auto___65710 + (1));
i__5741__auto___65710 = G__65711;
continue;
} else {
}
break;
