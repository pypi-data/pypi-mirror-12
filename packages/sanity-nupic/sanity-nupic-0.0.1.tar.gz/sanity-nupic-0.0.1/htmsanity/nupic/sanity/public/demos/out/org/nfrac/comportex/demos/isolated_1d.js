...
org.nfrac.comportex.demos.isolated_1d.world_transform = (function org$nfrac$comportex$demos$isolated_1d$world_transform(p__64147){
var map__64151 = p__64147;
var map__64151__$1 = ((((!((map__64151 == null)))?((((map__64151.cljs$lang$protocol_mask$partition0$ & (64))) || (map__64151.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__64151):map__64151);
var input = map__64151__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64151__$1,cljs.core.cst$kw$id);
var values = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64151__$1,cljs.core.cst$kw$values);
var index = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64151__$1,cljs.core.cst$kw$index);
...
var vec__64153 = clojure.test.check.random.split(cljs.core.cst$kw$org$nfrac$comportex$demos$isolated_DASH_1d_SLASH_rng.cljs$core$IFn$_invoke$arity$1(cljs.core.meta(input)));
var rng = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64153,(0),null);
var rng_STAR_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64153,(1),null);
...
org.nfrac.comportex.demos.isolated_1d.block_sensor = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$value,org.nfrac.comportex.encoders.linear_encoder(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [org.nfrac.comportex.demos.isolated_1d.bit_width], null),org.nfrac.comportex.demos.isolated_1d.n_on_bits,org.nfrac.comportex.demos.isolated_1d.numb_domain)], null);
...
var args64154 = [];
var len__5740__auto___64157 = arguments.length;
var i__5741__auto___64158 = (0);
while(true){
if((i__5741__auto___64158 < len__5740__auto___64157)){
args64154.push((arguments[i__5741__auto___64158]));

var G__64159 = (i__5741__auto___64158 + (1));
i__5741__auto___64158 = G__64159;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args64154.length)].join('')));
