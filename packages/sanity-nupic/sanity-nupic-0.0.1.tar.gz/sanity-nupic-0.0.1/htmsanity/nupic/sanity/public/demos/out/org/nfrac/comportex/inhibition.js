...
return (function org$nfrac$comportex$inhibition$column_receptive_field_size_$_iter__34583(s__34584){
return (new cljs.core.LazySeq(null,((function (m,ids,coords){
return (function (){
var s__34584__$1 = s__34584;
while(true){
var temp__4653__auto__ = cljs.core.seq(s__34584__$1);
if(temp__4653__auto__){
var s__34584__$2 = temp__4653__auto__;
if(cljs.core.chunked_seq_QMARK_(s__34584__$2)){
var c__5452__auto__ = cljs.core.chunk_first(s__34584__$2);
var size__5453__auto__ = cljs.core.count(c__5452__auto__);
var b__34586 = cljs.core.chunk_buffer(size__5453__auto__);
if((function (){var i__34585 = (0);
while(true){
if((i__34585 < size__5453__auto__)){
var j = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__5452__auto__,i__34585);
cljs.core.chunk_append(b__34586,org.nfrac.comportex.inhibition.numeric_span(cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (i__34585,j,c__5452__auto__,size__5453__auto__,b__34586,s__34584__$2,temp__4653__auto__,m,ids,coords){
return (function (p1__34576_SHARP_){
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2(p1__34576_SHARP_,j);
});})(i__34585,j,c__5452__auto__,size__5453__auto__,b__34586,s__34584__$2,temp__4653__auto__,m,ids,coords))
,coords)));

var G__34589 = (i__34585 + (1));
i__34585 = G__34589;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__34586),org$nfrac$comportex$inhibition$column_receptive_field_size_$_iter__34583(cljs.core.chunk_rest(s__34584__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__34586),null);
}
} else {
var j = cljs.core.first(s__34584__$2);
return cljs.core.cons(org.nfrac.comportex.inhibition.numeric_span(cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (j,s__34584__$2,temp__4653__auto__,m,ids,coords){
return (function (p1__34576_SHARP_){
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2(p1__34576_SHARP_,j);
});})(j,s__34584__$2,temp__4653__auto__,m,ids,coords))
,coords)),org$nfrac$comportex$inhibition$column_receptive_field_size_$_iter__34583(cljs.core.rest(s__34584__$2)));
}
} else {
return null;
}
...
var G__34590 = cljs.core.next(nbs);
var G__34591 = cljs.core.assoc_BANG_.cljs$core$IFn$_invoke$arity$3(emask__$1,nb_col,null);
nbs = G__34590;
emask__$1 = G__34591;
continue;
} else {
var G__34592 = cljs.core.next(nbs);
var G__34593 = emask__$1;
nbs = G__34592;
emask__$1 = G__34593;
continue;
}
} else {
var G__34594 = cljs.core.next(nbs);
var G__34595 = emask__$1;
nbs = G__34594;
emask__$1 = G__34595;
continue;
}
...
var G__34596 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(sel_cols,col);
var G__34597 = cljs.core.next(more_cols);
var G__34598 = org.nfrac.comportex.inhibition.mask_out_inhibited_by_col(emask,col,x,topo,inh_radius,inh_base_dist);
sel_cols = G__34596;
more_cols = G__34597;
emask = G__34598;
continue;
} else {
var G__34599 = sel_cols;
var G__34600 = cljs.core.next(more_cols);
var G__34601 = emask;
sel_cols = G__34599;
more_cols = G__34600;
emask = G__34601;
