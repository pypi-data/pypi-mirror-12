...
var vec__39421 = (function (){var el__$1 = el;
var x = (0);
var y = (0);
while(true){
...
var G__39428 = el__$1.offsetParent;
var G__39429 = (function (){var G__39422 = (function (){var G__39423 = (x + el__$1.offsetLeft);
if(include_border_QMARK_){
return (G__39423 + (function (){var G__39424 = s.borderLeftWidth;
return parseInt(G__39424);
})());
} else {
return G__39423;
}
...
return (G__39422 - el__$1.scrollLeft);
} else {
return G__39422;
}
})();
var G__39430 = (function (){var G__39425 = (function (){var G__39426 = (y + el__$1.offsetTop);
if(include_border_QMARK_){
return (G__39426 + (function (){var G__39427 = s.borderTopWidth;
return parseInt(G__39427);
})());
} else {
return G__39426;
}
...
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(el__$1,document.body)){
return (G__39425 - el__$1.scrollTop);
} else {
return G__39425;
}
})();
...
var left = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39421,(0),null);
var top = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39421,(1),null);
...
var vec__39432 = org.numenta.sanity.dom.get_bounding_page_rect(el);
var left = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39432,(0),null);
var top = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39432,(1),null);
var right = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39432,(2),null);
var bottom = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39432,(3),null);
...
var vec__39434 = org.numenta.sanity.dom.get_bounding_page_rect(el);
var left = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39434,(0),null);
var top = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39434,(1),null);
var right = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39434,(2),null);
var bottom = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39434,(3),null);
