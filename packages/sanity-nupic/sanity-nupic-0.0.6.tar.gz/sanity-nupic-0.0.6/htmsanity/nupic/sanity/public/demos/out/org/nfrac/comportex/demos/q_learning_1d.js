...
org.nfrac.comportex.demos.q_learning_1d.column__GT_signal = cljs.core.zipmap(cljs.core.range.cljs$core$IFn$_invoke$arity$0(),(function (){var iter__5454__auto__ = (function org$nfrac$comportex$demos$q_learning_1d$iter__65111(s__65112){
return (new cljs.core.LazySeq(null,(function (){
var s__65112__$1 = s__65112;
while(true){
var temp__4653__auto__ = cljs.core.seq(s__65112__$1);
if(temp__4653__auto__){
var xs__5201__auto__ = temp__4653__auto__;
var direction = cljs.core.first(xs__5201__auto__);
var iterys__5450__auto__ = ((function (s__65112__$1,direction,xs__5201__auto__,temp__4653__auto__){
return (function org$nfrac$comportex$demos$q_learning_1d$iter__65111_$_iter__65113(s__65114){
return (new cljs.core.LazySeq(null,((function (s__65112__$1,direction,xs__5201__auto__,temp__4653__auto__){
return (function (){
var s__65114__$1 = s__65114;
while(true){
var temp__4653__auto____$1 = cljs.core.seq(s__65114__$1);
if(temp__4653__auto____$1){
var s__65114__$2 = temp__4653__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__65114__$2)){
var c__5452__auto__ = cljs.core.chunk_first(s__65114__$2);
var size__5453__auto__ = cljs.core.count(c__5452__auto__);
var b__65116 = cljs.core.chunk_buffer(size__5453__auto__);
if((function (){var i__65115 = (0);
while(true){
if((i__65115 < size__5453__auto__)){
var influence = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__5452__auto__,i__65115);
cljs.core.chunk_append(b__65116,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [direction,influence], null));

var G__65122 = (i__65115 + (1));
i__65115 = G__65122;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__65116),org$nfrac$comportex$demos$q_learning_1d$iter__65111_$_iter__65113(cljs.core.chunk_rest(s__65114__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__65116),null);
}
} else {
var influence = cljs.core.first(s__65114__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [direction,influence], null),org$nfrac$comportex$demos$q_learning_1d$iter__65111_$_iter__65113(cljs.core.rest(s__65114__$2)));
}
} else {
return null;
}
...
});})(s__65112__$1,direction,xs__5201__auto__,temp__4653__auto__))
,null,null));
});})(s__65112__$1,direction,xs__5201__auto__,temp__4653__auto__))
;
var fs__5451__auto__ = cljs.core.seq(iterys__5450__auto__(cljs.core.repeat.cljs$core$IFn$_invoke$arity$2((15),1.0)));
if(fs__5451__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__5451__auto__,org$nfrac$comportex$demos$q_learning_1d$iter__65111(cljs.core.rest(s__65112__$1)));
} else {
var G__65123 = cljs.core.rest(s__65112__$1);
s__65112__$1 = G__65123;
continue;
}
} else {
return null;
...
var G__65131 = cljs.core.key(cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.max_key,cljs.core.val,cljs.core.shuffle(cljs.core.persistent_BANG_(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(((function (alyr,acols,signals){
return (function (m,p__65132){
var vec__65133 = p__65132;
var motion = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65133,(0),null);
var influence = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65133,(1),null);
...
return (org.nfrac.comportex.demos.q_learning_1d.direction__GT_action.cljs$core$IFn$_invoke$arity$1 ? org.nfrac.comportex.demos.q_learning_1d.direction__GT_action.cljs$core$IFn$_invoke$arity$1(G__65131) : org.nfrac.comportex.demos.q_learning_1d.direction__GT_action.call(null,G__65131));
});
...
return cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p__65136){
var vec__65137 = p__65136;
var in_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65137,(0),null);
var p = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65137,(1),null);
...
return cljs.core.keep.cljs$core$IFn$_invoke$arity$2((function (p__65140){
var vec__65141 = p__65140;
var in_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65141,(0),null);
var p = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65141,(1),null);
...
var map__65144 = org.nfrac.comportex.protocols.params(lyr);
var map__65144__$1 = ((((!((map__65144 == null)))?((((map__65144.cljs$lang$protocol_mask$partition0$ & (64))) || (map__65144.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__65144):map__65144);
var ff_perm_init_lo = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65144__$1,cljs.core.cst$kw$ff_DASH_perm_DASH_init_DASH_lo);
var q_alpha = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65144__$1,cljs.core.cst$kw$q_DASH_alpha);
var q_discount = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65144__$1,cljs.core.cst$kw$q_DASH_discount);
...
var aperms = cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(((function (prev_lyr,map__65144,map__65144__$1,ff_perm_init_lo,q_alpha,q_discount,ff_bits,acols,prev_ff_bits,prev_acols,psg){
return (function (col){
...
});})(prev_lyr,map__65144,map__65144__$1,ff_perm_init_lo,q_alpha,q_discount,ff_bits,acols,prev_ff_bits,prev_acols,psg))
...
var seg_updates = cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (prev_lyr,map__65144,map__65144__$1,ff_perm_init_lo,q_alpha,q_discount,ff_bits,acols,prev_ff_bits,prev_acols,psg,aperms,Q_est,Q_old,learn_value,adjust,op){
return (function (col){
...
});})(prev_lyr,map__65144,map__65144__$1,ff_perm_init_lo,q_alpha,q_discount,ff_bits,acols,prev_ff_bits,prev_acols,psg,aperms,Q_est,Q_old,learn_value,adjust,op))
,prev_acols);
...
var new_inval_65146 = org.nfrac.comportex.demos.q_learning_1d.apply_action(inval_with_action);
cljs.core.async.put_BANG_.cljs$core$IFn$_invoke$arity$2(world_c,new_inval_65146);
