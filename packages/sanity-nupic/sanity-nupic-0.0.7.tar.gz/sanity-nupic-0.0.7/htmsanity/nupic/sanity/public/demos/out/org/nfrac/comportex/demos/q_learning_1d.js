...
org.nfrac.comportex.demos.q_learning_1d.column__GT_signal = cljs.core.zipmap(cljs.core.range.cljs$core$IFn$_invoke$arity$0(),(function (){var iter__5454__auto__ = (function org$nfrac$comportex$demos$q_learning_1d$iter__65109(s__65110){
return (new cljs.core.LazySeq(null,(function (){
var s__65110__$1 = s__65110;
while(true){
var temp__4653__auto__ = cljs.core.seq(s__65110__$1);
if(temp__4653__auto__){
var xs__5201__auto__ = temp__4653__auto__;
var direction = cljs.core.first(xs__5201__auto__);
var iterys__5450__auto__ = ((function (s__65110__$1,direction,xs__5201__auto__,temp__4653__auto__){
return (function org$nfrac$comportex$demos$q_learning_1d$iter__65109_$_iter__65111(s__65112){
return (new cljs.core.LazySeq(null,((function (s__65110__$1,direction,xs__5201__auto__,temp__4653__auto__){
return (function (){
var s__65112__$1 = s__65112;
while(true){
var temp__4653__auto____$1 = cljs.core.seq(s__65112__$1);
if(temp__4653__auto____$1){
var s__65112__$2 = temp__4653__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__65112__$2)){
var c__5452__auto__ = cljs.core.chunk_first(s__65112__$2);
var size__5453__auto__ = cljs.core.count(c__5452__auto__);
var b__65114 = cljs.core.chunk_buffer(size__5453__auto__);
if((function (){var i__65113 = (0);
while(true){
if((i__65113 < size__5453__auto__)){
var influence = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__5452__auto__,i__65113);
cljs.core.chunk_append(b__65114,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [direction,influence], null));

var G__65120 = (i__65113 + (1));
i__65113 = G__65120;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__65114),org$nfrac$comportex$demos$q_learning_1d$iter__65109_$_iter__65111(cljs.core.chunk_rest(s__65112__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__65114),null);
}
} else {
var influence = cljs.core.first(s__65112__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [direction,influence], null),org$nfrac$comportex$demos$q_learning_1d$iter__65109_$_iter__65111(cljs.core.rest(s__65112__$2)));
}
} else {
return null;
}
...
});})(s__65110__$1,direction,xs__5201__auto__,temp__4653__auto__))
,null,null));
});})(s__65110__$1,direction,xs__5201__auto__,temp__4653__auto__))
;
var fs__5451__auto__ = cljs.core.seq(iterys__5450__auto__(cljs.core.repeat.cljs$core$IFn$_invoke$arity$2((15),1.0)));
if(fs__5451__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__5451__auto__,org$nfrac$comportex$demos$q_learning_1d$iter__65109(cljs.core.rest(s__65110__$1)));
} else {
var G__65121 = cljs.core.rest(s__65110__$1);
s__65110__$1 = G__65121;
continue;
}
} else {
return null;
...
var G__65129 = cljs.core.key(cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.max_key,cljs.core.val,cljs.core.shuffle(cljs.core.persistent_BANG_(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(((function (alyr,acols,signals){
return (function (m,p__65130){
var vec__65131 = p__65130;
var motion = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65131,(0),null);
var influence = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65131,(1),null);
...
return (org.nfrac.comportex.demos.q_learning_1d.direction__GT_action.cljs$core$IFn$_invoke$arity$1 ? org.nfrac.comportex.demos.q_learning_1d.direction__GT_action.cljs$core$IFn$_invoke$arity$1(G__65129) : org.nfrac.comportex.demos.q_learning_1d.direction__GT_action.call(null,G__65129));
});
...
return cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p__65134){
var vec__65135 = p__65134;
var in_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65135,(0),null);
var p = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65135,(1),null);
...
return cljs.core.keep.cljs$core$IFn$_invoke$arity$2((function (p__65138){
var vec__65139 = p__65138;
var in_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65139,(0),null);
var p = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65139,(1),null);
...
var map__65142 = org.nfrac.comportex.protocols.params(lyr);
var map__65142__$1 = ((((!((map__65142 == null)))?((((map__65142.cljs$lang$protocol_mask$partition0$ & (64))) || (map__65142.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__65142):map__65142);
var ff_perm_init_lo = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65142__$1,cljs.core.cst$kw$ff_DASH_perm_DASH_init_DASH_lo);
var q_alpha = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65142__$1,cljs.core.cst$kw$q_DASH_alpha);
var q_discount = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65142__$1,cljs.core.cst$kw$q_DASH_discount);
...
var aperms = cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(((function (prev_lyr,map__65142,map__65142__$1,ff_perm_init_lo,q_alpha,q_discount,ff_bits,acols,prev_ff_bits,prev_acols,psg){
return (function (col){
...
});})(prev_lyr,map__65142,map__65142__$1,ff_perm_init_lo,q_alpha,q_discount,ff_bits,acols,prev_ff_bits,prev_acols,psg))
...
var seg_updates = cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (prev_lyr,map__65142,map__65142__$1,ff_perm_init_lo,q_alpha,q_discount,ff_bits,acols,prev_ff_bits,prev_acols,psg,aperms,Q_est,Q_old,learn_value,adjust,op){
return (function (col){
...
});})(prev_lyr,map__65142,map__65142__$1,ff_perm_init_lo,q_alpha,q_discount,ff_bits,acols,prev_ff_bits,prev_acols,psg,aperms,Q_est,Q_old,learn_value,adjust,op))
,prev_acols);
...
var new_inval_65144 = org.nfrac.comportex.demos.q_learning_1d.apply_action(inval_with_action);
cljs.core.async.put_BANG_.cljs$core$IFn$_invoke$arity$2(world_c,new_inval_65144);
