...
org.nfrac.comportex.util.algo_graph.DirectedGraph.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5298__auto__,k34104,else__5299__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k34104,else__5299__auto__);
...
org.nfrac.comportex.util.algo_graph.DirectedGraph.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__34103){
var self__ = this;
var G__34103__$1 = this;
return (new cljs.core.RecordIter((0),G__34103__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$nodes,cljs.core.cst$kw$neighbors], null),cljs.core._iterator(self__.__extmap)));
});
...
org.nfrac.comportex.util.algo_graph.DirectedGraph.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5303__auto__,k__5304__auto__,G__34103){
var self__ = this;
var this__5303__auto____$1 = this;
var pred__34107 = cljs.core.keyword_identical_QMARK_;
var expr__34108 = k__5304__auto__;
if(cljs.core.truth_((pred__34107.cljs$core$IFn$_invoke$arity$2 ? pred__34107.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$nodes,expr__34108) : pred__34107.call(null,cljs.core.cst$kw$nodes,expr__34108)))){
return (new org.nfrac.comportex.util.algo_graph.DirectedGraph(G__34103,self__.neighbors,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__34107.cljs$core$IFn$_invoke$arity$2 ? pred__34107.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$neighbors,expr__34108) : pred__34107.call(null,cljs.core.cst$kw$neighbors,expr__34108)))){
return (new org.nfrac.comportex.util.algo_graph.DirectedGraph(self__.nodes,G__34103,self__.__meta,self__.__extmap,null));
} else {
return (new org.nfrac.comportex.util.algo_graph.DirectedGraph(self__.nodes,self__.neighbors,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5304__auto__,G__34103),null));
}
}
});
...
org.nfrac.comportex.util.algo_graph.DirectedGraph.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5295__auto__,G__34103){
var self__ = this;
var this__5295__auto____$1 = this;
return (new org.nfrac.comportex.util.algo_graph.DirectedGraph(self__.nodes,self__.neighbors,G__34103,self__.__extmap,self__.__hash));
});
...
org.nfrac.comportex.util.algo_graph.map__GT_DirectedGraph = (function org$nfrac$comportex$util$algo_graph$map__GT_DirectedGraph(G__34105){
return (new org.nfrac.comportex.util.algo_graph.DirectedGraph(cljs.core.cst$kw$nodes.cljs$core$IFn$_invoke$arity$1(G__34105),cljs.core.cst$kw$neighbors.cljs$core$IFn$_invoke$arity$1(G__34105),null,cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__34105,cljs.core.cst$kw$nodes,cljs.core.array_seq([cljs.core.cst$kw$neighbors], 0)),null));
});
...
var args34111 = [];
var len__5740__auto___34114 = arguments.length;
var i__5741__auto___34115 = (0);
while(true){
if((i__5741__auto___34115 < len__5740__auto___34114)){
args34111.push((arguments[i__5741__auto___34115]));

var G__34116 = (i__5741__auto___34115 + (1));
i__5741__auto___34115 = G__34116;
continue;
} else {
}
break;
 ...
 */
org.nfrac.comportex.util.algo_graph.post_ordered_visit = (function org$nfrac$comportex$util$algo_graph$post_ordered_visit(g,n,p__34118){
var vec__34121 = p__34118;
var visited = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34121,(0),null);
var acc = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34121,(1),null);
var state = vec__34121;
if(cljs.core.truth_((visited.cljs$core$IFn$_invoke$arity$1 ? visited.cljs$core$IFn$_invoke$arity$1(n) : visited.call(null,n)))){
return state;
} else {
var vec__34122 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(((function (vec__34121,visited,acc,state){
return (function (st,nd){
return org$nfrac$comportex$util$algo_graph$post_ordered_visit(g,nd,st);
});})(vec__34121,visited,acc,state))
...
var v2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34122,(0),null);
var acc2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34122,(1),null);
...
return cljs.core.fnext(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__34124_SHARP_,p2__34123_SHARP_){
return org.nfrac.comportex.util.algo_graph.post_ordered_visit(g,p2__34123_SHARP_,p1__34124_SHARP_);
...
var vec__34126 = org.nfrac.comportex.util.algo_graph.post_ordered_visit(rev,cljs.core.first(stack),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [visited,cljs.core.PersistentHashSet.EMPTY], null));
var nv = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34126,(0),null);
var comp = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34126,(1),null);
var ns = cljs.core.remove.cljs$core$IFn$_invoke$arity$2(nv,stack);
var G__34127 = ns;
var G__34128 = nv;
var G__34129 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(acc,comp);
stack = G__34127;
visited = G__34128;
acc = G__34129;
continue;
...
var args34131 = [];
var len__5740__auto___34134 = arguments.length;
var i__5741__auto___34135 = (0);
while(true){
if((i__5741__auto___34135 < len__5740__auto___34134)){
args34131.push((arguments[i__5741__auto___34135]));

var G__34136 = (i__5741__auto___34135 + (1));
i__5741__auto___34135 = G__34136;
continue;
} else {
}
break;
...
return cljs.core.some((function (p1__34130_SHARP_){
if(cljs.core.truth_((p1__34130_SHARP_.cljs$core$IFn$_invoke$arity$1 ? p1__34130_SHARP_.cljs$core$IFn$_invoke$arity$1(n) : p1__34130_SHARP_.call(null,n)))){
return p1__34130_SHARP_;
} else {
return null;
}
}),sccs);
...
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(p1__34138_SHARP_,n);
});})(n,or__4682__auto__))
...
var G__34139 = new_data;
var G__34140 = (function (){var and__4670__auto__ = idx;
if(cljs.core.truth_(and__4670__auto__)){
return (idx - (1));
} else {
return and__4670__auto__;
...
return (function (acc,p__34143){
var vec__34144 = p__34143;
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34144,(0),null);
var dep = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34144,(1),null);
...
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34148,(0),null);
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (update){
return (function (p__34151){
var vec__34152 = p__34151;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34152,(0),null);
