...
org.nfrac.comportex.demos.isolated_1d.world_transform = (function org$nfrac$comportex$demos$isolated_1d$world_transform(p__64150){
var map__64154 = p__64150;
var map__64154__$1 = ((((!((map__64154 == null)))?((((map__64154.cljs$lang$protocol_mask$partition0$ & (64))) || (map__64154.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__64154):map__64154);
var input = map__64154__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64154__$1,cljs.core.cst$kw$id);
var values = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64154__$1,cljs.core.cst$kw$values);
var index = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64154__$1,cljs.core.cst$kw$index);
...
var vec__64156 = clojure.test.check.random.split(cljs.core.cst$kw$org$nfrac$comportex$demos$isolated_DASH_1d_SLASH_rng.cljs$core$IFn$_invoke$arity$1(cljs.core.meta(input)));
var rng = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64156,(0),null);
var rng_STAR_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64156,(1),null);
...
var args64157 = [];
var len__5740__auto___64160 = arguments.length;
var i__5741__auto___64161 = (0);
while(true){
if((i__5741__auto___64161 < len__5740__auto___64160)){
args64157.push((arguments[i__5741__auto___64161]));

var G__64162 = (i__5741__auto___64161 + (1));
i__5741__auto___64161 = G__64162;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args64157.length)].join('')));
