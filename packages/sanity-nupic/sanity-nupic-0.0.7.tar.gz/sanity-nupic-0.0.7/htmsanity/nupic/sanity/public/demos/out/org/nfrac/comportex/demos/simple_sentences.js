...
return (function (p1__63910_SHARP_){
return cljs.core.vec(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(p1__63910_SHARP_,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["."], null)));
});})(text))
,cljs.core.mapv.cljs$core$IFn$_invoke$arity$2(((function (text){
return (function (p1__63909_SHARP_){
return clojure.string.split.cljs$core$IFn$_invoke$arity$2(p1__63909_SHARP_,/[^\w']+/);
});})(text))
...
var iter__5454__auto__ = (function org$nfrac$comportex$demos$simple_sentences$word_item_seq_$_iter__63948(s__63949){
return (new cljs.core.LazySeq(null,(function (){
var s__63949__$1 = s__63949;
while(true){
var temp__4653__auto__ = cljs.core.seq(s__63949__$1);
if(temp__4653__auto__){
var xs__5201__auto__ = temp__4653__auto__;
var vec__63971 = cljs.core.first(xs__5201__auto__);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63971,(0),null);
var sen = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63971,(1),null);
var iterys__5450__auto__ = ((function (s__63949__$1,vec__63971,i,sen,xs__5201__auto__,temp__4653__auto__){
return (function org$nfrac$comportex$demos$simple_sentences$word_item_seq_$_iter__63948_$_iter__63950(s__63951){
return (new cljs.core.LazySeq(null,((function (s__63949__$1,vec__63971,i,sen,xs__5201__auto__,temp__4653__auto__){
return (function (){
var s__63951__$1 = s__63951;
while(true){
var temp__4653__auto____$1 = cljs.core.seq(s__63951__$1);
if(temp__4653__auto____$1){
var xs__5201__auto____$1 = temp__4653__auto____$1;
var rep = cljs.core.first(xs__5201__auto____$1);
var iterys__5450__auto__ = ((function (s__63951__$1,s__63949__$1,rep,xs__5201__auto____$1,temp__4653__auto____$1,vec__63971,i,sen,xs__5201__auto__,temp__4653__auto__){
return (function org$nfrac$comportex$demos$simple_sentences$word_item_seq_$_iter__63948_$_iter__63950_$_iter__63952(s__63953){
return (new cljs.core.LazySeq(null,((function (s__63951__$1,s__63949__$1,rep,xs__5201__auto____$1,temp__4653__auto____$1,vec__63971,i,sen,xs__5201__auto__,temp__4653__auto__){
return (function (){
var s__63953__$1 = s__63953;
while(true){
var temp__4653__auto____$2 = cljs.core.seq(s__63953__$1);
if(temp__4653__auto____$2){
var s__63953__$2 = temp__4653__auto____$2;
if(cljs.core.chunked_seq_QMARK_(s__63953__$2)){
var c__5452__auto__ = cljs.core.chunk_first(s__63953__$2);
var size__5453__auto__ = cljs.core.count(c__5452__auto__);
var b__63955 = cljs.core.chunk_buffer(size__5453__auto__);
if((function (){var i__63954 = (0);
while(true){
if((i__63954 < size__5453__auto__)){
var vec__63983 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__5452__auto__,i__63954);
var j = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63983,(0),null);
var word = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63983,(1),null);
cljs.core.chunk_append(b__63955,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$word,word,cljs.core.cst$kw$index,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [i,j], null)], null));

var G__63985 = (i__63954 + (1));
i__63954 = G__63985;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__63955),org$nfrac$comportex$demos$simple_sentences$word_item_seq_$_iter__63948_$_iter__63950_$_iter__63952(cljs.core.chunk_rest(s__63953__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__63955),null);
}
} else {
var vec__63984 = cljs.core.first(s__63953__$2);
var j = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63984,(0),null);
var word = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63984,(1),null);
return cljs.core.cons(new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$word,word,cljs.core.cst$kw$index,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [i,j], null)], null),org$nfrac$comportex$demos$simple_sentences$word_item_seq_$_iter__63948_$_iter__63950_$_iter__63952(cljs.core.rest(s__63953__$2)));
}
} else {
return null;
}
...
});})(s__63951__$1,s__63949__$1,rep,xs__5201__auto____$1,temp__4653__auto____$1,vec__63971,i,sen,xs__5201__auto__,temp__4653__auto__))
,null,null));
});})(s__63951__$1,s__63949__$1,rep,xs__5201__auto____$1,temp__4653__auto____$1,vec__63971,i,sen,xs__5201__auto__,temp__4653__auto__))
;
...
if(fs__5451__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__5451__auto__,org$nfrac$comportex$demos$simple_sentences$word_item_seq_$_iter__63948_$_iter__63950(cljs.core.rest(s__63951__$1)));
} else {
var G__63986 = cljs.core.rest(s__63951__$1);
s__63951__$1 = G__63986;
continue;
}
} else {
return null;
...
});})(s__63949__$1,vec__63971,i,sen,xs__5201__auto__,temp__4653__auto__))
,null,null));
});})(s__63949__$1,vec__63971,i,sen,xs__5201__auto__,temp__4653__auto__))
;
var fs__5451__auto__ = cljs.core.seq(iterys__5450__auto__(cljs.core.range.cljs$core$IFn$_invoke$arity$1(n_repeats)));
if(fs__5451__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__5451__auto__,org$nfrac$comportex$demos$simple_sentences$word_item_seq_$_iter__63948(cljs.core.rest(s__63949__$1)));
} else {
var G__63987 = cljs.core.rest(s__63949__$1);
s__63949__$1 = G__63987;
continue;
}
} else {
return null;
...
var args63988 = [];
var len__5740__auto___63991 = arguments.length;
var i__5741__auto___63992 = (0);
while(true){
if((i__5741__auto___63992 < len__5740__auto___63991)){
args63988.push((arguments[i__5741__auto___63992]));

var G__63993 = (i__5741__auto___63992 + (1));
i__5741__auto___63992 = G__63993;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args63988.length)].join('')));
