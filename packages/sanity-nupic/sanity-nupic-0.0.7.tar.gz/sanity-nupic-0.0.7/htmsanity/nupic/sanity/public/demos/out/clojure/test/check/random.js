...
var G__34191 = z;
if(((24) > (function (){var G__34192 = clojure.test.check.random.bxoubsr(z,(1));
return (clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1 ? clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1(G__34192) : clojure.test.check.random.longs.bit_count.call(null,G__34192));
})())){
return clojure.test.check.random.longs.bit_xor(G__34191,clojure.test.check.random.mix_gamma_const_3);
} else {
return G__34191;
}
});
...
var G__34195 = state_SINGLEQUOTE__SINGLEQUOTE_;
var G__34196 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(ret,new_rng);
state__$1 = G__34195;
ret = G__34196;
continue;
}
...
clojure.test.check.random.next_rng = (function (){var a = (function (){var G__34197 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$state,clojure.test.check.random.make_java_util_splittable_random((new Date()).valueOf())], null);
return (cljs.core.atom.cljs$core$IFn$_invoke$arity$1 ? cljs.core.atom.cljs$core$IFn$_invoke$arity$1(G__34197) : cljs.core.atom.call(null,G__34197));
})();
return ((function (a){
return (function (){
...
var map__34199__$1 = ((((!((map__34199 == null)))?((((map__34199.cljs$lang$protocol_mask$partition0$ & (64))) || (map__34199.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__34199):map__34199);
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34199__$1,cljs.core.cst$kw$state);
var vec__34201 = clojure.test.check.random.split(state);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34201,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34201,(1),null);
...
var args34202 = [];
var len__5740__auto___34205 = arguments.length;
var i__5741__auto___34206 = (0);
while(true){
if((i__5741__auto___34206 < len__5740__auto___34205)){
args34202.push((arguments[i__5741__auto___34206]));

var G__34207 = (i__5741__auto___34206 + (1));
i__5741__auto___34206 = G__34207;
continue;
} else {
}
break;
