...
org.nfrac.comportex.demos.coordinates_2d.clamp_vec = (function org$nfrac$comportex$demos$coordinates_2d$clamp_vec(p__65697,max_mag){
var vec__65700 = p__65697;
var vx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65700,(0),null);
var vy = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65700,(1),null);
var mag = (function (){var G__65701 = ((vx * vx) + (vy * vy));
return Math.sqrt(G__65701);
})();
...
org.nfrac.comportex.demos.coordinates_2d.input_transform = (function org$nfrac$comportex$demos$coordinates_2d$input_transform(p__65702){
var map__65706 = p__65702;
var map__65706__$1 = ((((!((map__65706 == null)))?((((map__65706.cljs$lang$protocol_mask$partition0$ & (64))) || (map__65706.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__65706):map__65706);
var x = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65706__$1,cljs.core.cst$kw$x);
var y = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65706__$1,cljs.core.cst$kw$y);
var vx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65706__$1,cljs.core.cst$kw$vx);
var vy = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65706__$1,cljs.core.cst$kw$vy);
var ax = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65706__$1,cljs.core.cst$kw$ax);
var ay = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65706__$1,cljs.core.cst$kw$ay);
var vec__65708 = org.nfrac.comportex.demos.coordinates_2d.clamp_vec(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(vx + ax),(vy + ay)], null),org.nfrac.comportex.demos.coordinates_2d.max_vel);
var vx2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65708,(0),null);
var vy2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65708,(1),null);
var x2 = (x + vx);
var y2 = (y + vy);
...
var args65709 = [];
var len__5740__auto___65712 = arguments.length;
var i__5741__auto___65713 = (0);
while(true){
if((i__5741__auto___65713 < len__5740__auto___65712)){
args65709.push((arguments[i__5741__auto___65713]));

var G__65714 = (i__5741__auto___65713 + (1));
i__5741__auto___65713 = G__65714;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args65709.length)].join('')));
