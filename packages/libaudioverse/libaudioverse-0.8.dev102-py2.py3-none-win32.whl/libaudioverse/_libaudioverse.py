...
LavEventCallback = ctypes.CFUNCTYPE(None, LavHandle, ctypes.c_void_p)
...
Lav_nodeGetEventHandler = ctypes.CFUNCTYPE(LavError, LavHandle, ctypes.c_int, ctypes.POINTER(LavEventCallback))(('Lav_nodeGetEventHandler', libaudioverse_module))
Lav_nodeGetEventUserDataPointer = ctypes.CFUNCTYPE(LavError, LavHandle, ctypes.c_int, ctypes.POINTER(ctypes.c_void_p))(('Lav_nodeGetEventUserDataPointer', libaudioverse_module))
Lav_nodeSetEvent = ctypes.CFUNCTYPE(LavError, LavHandle, ctypes.c_int, LavEventCallback, ctypes.c_void_p)(('Lav_nodeSetEvent', libaudioverse_module))
