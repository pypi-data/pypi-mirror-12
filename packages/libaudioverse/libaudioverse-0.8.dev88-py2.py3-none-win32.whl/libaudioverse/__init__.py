...
class GraphListenerNode(GenericNode):
    r"""This node defines a callback which is called with the audio data passing through this node for the current block.
...
class NestedAllpassNetworkNode(GenericNode):
    r"""This node implements nested first-order allpass filters.
...
class FdnReverbNode(GenericNode):
    r"""An 8 delay line FDN reverberator, based off a houseolder reflection.
