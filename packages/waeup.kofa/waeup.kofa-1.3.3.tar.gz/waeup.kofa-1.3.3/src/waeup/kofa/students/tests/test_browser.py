## $Id: test_browser.py 13241 2015-09-04 15:00:11Z henrik $
## 
...
class OfficerUITests(StudentsFullSetup):
    ...
    def test_manage_accommodation(self):
        ...
        logcontent = open(logfile).read()
        self.assertTrue('zope.mgr - students.browser.BedTicketRelocationView '
...
class StudentUITests(StudentsFullSetup):
    ...
    def test_student_clearance(self):
        ...
        # (email is already required in the interface, but phone not)
