...
class UserApi(object):
    ...
    def user_password_change(self, id, username, oldPassword, password):
    ...
    def user_orders(self, user_id, page = None, page_size = None):
