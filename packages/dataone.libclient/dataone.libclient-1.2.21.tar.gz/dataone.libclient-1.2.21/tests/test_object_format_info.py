...
class TestObjectFormatInfo(TestCaseWithURLCompare):
  ...
  def test_200(self):
    ...
    self.assertEqual(self.i.content_type_from_format_id('netCDF-3'),
                                               'application/netcdf')


  def test_300(self):
    '''filename_extension_from_format_id()'''
    self.assertEqual(self.i.filename_extension_from_format_id('netCDF-3'),
                                               '.nc')
  ...
  def test_500(self):
    ...
    self.assertEqual(self.i.filename_extension_from_format_id('abcd'),
                                               'ijkl')
