...
Version 0.7.5 - 2015-11-29
  ...
  * Python only version runs with CPython (2.7, 3.4, 3.5), pypy-4.0.1 and pypy3-2.4.0
  * can run Cython extensions on Win7 only with CPython 3.4 :(
  ...
  * KNOWN BUG: Win7 and Python 3.5.0 - can't build Cython extension with MingW32
