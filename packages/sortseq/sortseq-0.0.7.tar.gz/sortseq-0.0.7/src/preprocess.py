...
def add_subparser(subparsers):
    ...
    p.add_argument(
         '--LHS_start',default=0,help='''Beginning of unmutated region for LHS
         matching''')
    p.add_argument(
         '--LHS_end',default=10,help='''End of unmutated region for LHS
         matching''')
    p.add_argument(
         '--RHS_start',default=-10,help='''Beginning of unmutated region for RHS
         matching''')
    p.add_argument(
         '--RHS_end',default=-1,help='''End of unmutated region for RHS
         matching''')
    p.add_argument(
