...
class Postprocessing(object):
    def __init__(self, sim = None):
        ...
        try:
            ...
            ERROR_MSG = "Error: Paraview python package is not installed"
    ...
    def get_massflow_rate_2D(self, folder, A_2d, A_3d, phases, point, normal):
        ...
        for vtm in spp.pa.get_all(folder):
            ...
            try:
                ...
                MSG = "get_massflow_rate_2D: Could not get the mass flow rate at point "+str(point)
                logger.warning(MSG)
                print MSG
        return mfrs
    ...
    def plot(self, folder, name, x, y, xlabel, ylabel):
        ...
        try:
            ...
            MSG = "plot(): could not plot with matplotlib"
            logger.warning(MSG)
            print MSG
    ...
    def get_mass_flow_rate(self, bc_name, phase=None):
        ...
        for surface in surfaces:
            ...
            return res['res']/depth

    def get_depth(self):
        is2D, dir = self.sim.setup.mesher.is2D()
        if is2D:
            l = self.sim.setup.mesher.get_max(dir)-self.sim.setup.mesher.get_min(dir)
            return l
        else:
            return 1.0
