...
class CAD(object):
    ...
    def load_freecad(self):
        try:
            ...
            MSG = "import FreeCAD failed. Initializing CAD object with empty attributes"
            print "WARNING: "+MSG
            logger.warning(MSG)
            logger.warning("FreeCAD path: "+str(self.freecad_path))
    ...
    def make_pipe(self, wire, circle, filename):
        try:
            ...
            print "Can not create Pipe and save it as "+filename
            print e
            sys.exit()
