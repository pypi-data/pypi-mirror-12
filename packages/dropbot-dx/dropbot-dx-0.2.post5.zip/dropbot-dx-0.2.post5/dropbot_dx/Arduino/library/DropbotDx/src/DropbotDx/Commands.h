...
/* #########################################################################
 * [2015-11-10 18:11:30.597000] THIS FILE IS AUTOGENERATED - DO NOT EDIT!
 * ######################################################################### */
...
typedef struct __attribute__((packed)) {
} MagnetEngageResponse;

typedef struct __attribute__((packed)) {
} MagnetDisengageRequest;

typedef struct __attribute__((packed)) {
} MagnetDisengageResponse;
...
static const int CMD_MAGNET_ENGAGE = 0x703;
static const int CMD_MAGNET_DISENGAGE = 0x704;
static const int CMD_LIGHT_OVERRIDE = 0x705;
static const int CMD_LIGHT_ENABLED = 0x706;
static const int CMD_LIGHT_ENABLE = 0x707;
static const int CMD_LIGHT_DISABLE = 0x708;
static const int CMD_LOOP = 0x709;
static const int CMD_ON_STATE_MAGNET_ENGAGED_CHANGED = 0x70a;
static const int CMD_ON_STATE_LIGHT_ENABLED_CHANGED = 0x70b;
