...
# ############################################################################
# [2015-11-10 18:11:31.938000] THIS FILE IS AUTOGENERATED - DO NOT EDIT!
# ############################################################################
import types
import pandas as pd
import numpy as np
...
class Proxy(ProxyBase):
    ...
    _CMD_MAGNET_ENGAGE = 0x703
    _CMD_MAGNET_DISENGAGE = 0x704
    _CMD_LIGHT_OVERRIDE = 0x705
    _CMD_LIGHT_ENABLED = 0x706
    _CMD_LIGHT_ENABLE = 0x707
    _CMD_LIGHT_DISABLE = 0x708
    _CMD_LOOP = 0x709
    _CMD_ON_STATE_MAGNET_ENGAGED_CHANGED = 0x70a
    _CMD_ON_STATE_LIGHT_ENABLED_CHANGED = 0x70b
    MAX_COMMAND_CODE = 1803
    ...
    def magnet_engage(self):
        command = np.dtype('uint16').type(self._CMD_MAGNET_ENGAGE)
        payload_size = 0
        payload_data = ''
    ...
    def magnet_disengage(self):
        command = np.dtype('uint16').type(self._CMD_MAGNET_DISENGAGE)
        payload_size = 0
        payload_data = ''
    ...
    def light_enable(self):
        command = np.dtype('uint16').type(self._CMD_LIGHT_ENABLE)
        payload_size = 0
        payload_data = ''
    ...
    def light_disable(self):
        command = np.dtype('uint16').type(self._CMD_LIGHT_DISABLE)
        payload_size = 0
        payload_data = ''
