...
commandList = [['temperature,#text', '==', 20], '&', [['temperature,#text', '==', True], '&',
...
def helperTests():
    ...
    print "helper test"
    print "------------"
    print splitUpPath("abc,@def")  # custom exceptions gehen nicht, sollte jedoch kein problem sein
