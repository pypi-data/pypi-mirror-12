...
dst="$(readlink -m $1)"
TOP="$PWD"
skaopts="--prefix=$dst --libdir=$dst/lib --with-include=$dst/include --with-lib=$dst/lib --with-dynlib=$dst/lib --enable-static --disable-shared --enable-allstatic --enable-force-devr --enable-tai-clock"
