...
## Issue tracker
cghq uses the excellent [GitHub issue tracker][issues].

Personally, I also recommend giving [ZenHub][zenhub] a try. After installing the Google Chrome plugin, visit the [cghq boards][repo-boards]. This way, it's very easy to get an overview of the current bug/feature request situation.
...
### Report Bugs
Report bugs at [Clinical-Genomics/cghq/issues][issues].
...
### Write Documentation
Clinical HQ could always use more documentation, whether as part of the official Clinical HQ docs, in inline docstrings, or even on the web in blog posts, articles, and such.
...
## Get Started!
Ready to contribute? Here's how to set up `Clinical HQ` for local development.

> Over time my ambition is to provide a reproducable and automated setup through Vagrant.

1. Fork the [Clinical-Genomics/cghq][repo] repo on GitHub

2. Clone your fork locally:

  ```bash
  $ git clone git@github.com:<your github username>/cghq.git
  ```
...
## Coding conventions
Generally I recommend two ways to stay up-to-date on cghq coding standards.
...
[issues]: https://github.com/Clinical-Genomics/cghq/issues
[repo]: https://github.com/Clinical-Genomics/cghq
[repo-boards]: https://github.com/Clinical-Genomics/cghq/issues#boards
[sourcetree]: http://www.sourcetreeapp.com/
[travis]: https://travis-ci.org/Clinical-Genomics/cghq/pull_requests
