...
from botocorev063p.utils import normalize_url_path, percent_encode_sequence
from botocorev063p.utils import percent_encode
from botocorev063p.compat import HTTPHeaders
from botocorev063p.compat import quote, unquote, urlsplit, parse_qs
from botocorev063p.compat import urlunsplit
from botocorev063p.compat import encodebytes
