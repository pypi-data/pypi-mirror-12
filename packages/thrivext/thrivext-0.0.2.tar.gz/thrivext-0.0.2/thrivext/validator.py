...
class Validator(object):
    ...
    def runmapper(self):
        ...
        # TODO: How to handle large amounts of input data
    ...
    def validate_colvals(self):
        ...
        details = "\n".join(msgs)
        if passed:
            result, action, details = "PASS", "None", details
        else:
            result, action, details = "FAIL", "ACTION HERE", details
