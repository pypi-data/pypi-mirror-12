...
#try converting README.md to README.rst since PyPI only supports RST
#do pip install pypandoc firstly
try:
...
setup(name='xgboost',
      ...
      description=read_md(os.path.join(CURRENT_DIR, 'README.md')),
      install_requires=[
          'numpy',
          'scipy',
      ],
