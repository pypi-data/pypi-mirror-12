...
.. image:: https://travis-ci.org/posita/txrc.svg?branch=v0.2.2
    :target: https://travis-ci.org/posita/txrc?branch=v0.2.2
    :alt: [Build Status]

.. image:: https://coveralls.io/repos/posita/txrc/badge.svg?branch=v0.2.2
    :target: https://coveralls.io/r/posita/txrc?branch=v0.2.2
    :alt: [Coverage Status]
...
.. image:: https://img.shields.io/pypi/v/txrc/0.2.2.svg
    :target: https://pypi.python.org/pypi/txrc/0.2.2
    :alt: [v0.2.2 Version]

.. image:: https://readthedocs.org/projects/txrc/badge/?version=v0.2.2
    :target: https://txrc.readthedocs.org/en/v0.2.2/
    :alt: [v0.2.2 Documentation]

.. image:: https://img.shields.io/pypi/l/txrc/0.2.2.svg
    :target: http://opensource.org/licenses/MIT
    :alt: [v0.2.2 License]

.. image:: https://img.shields.io/pypi/pyversions/txrc/0.2.2.svg
    :target: https://pypi.python.org/pypi/txrc/0.2.2
    :alt: [v0.2.2 Supported Python Versions]

.. image:: https://img.shields.io/pypi/implementation/txrc/0.2.2.svg
    :target: https://pypi.python.org/pypi/txrc/0.2.2
    :alt: [v0.2.2 Supported Python Implementations]

.. image:: https://img.shields.io/pypi/status/txrc/0.2.2.svg
    :target: https://pypi.python.org/pypi/txrc/0.2.2
    :alt: [v0.2.2 Development Stage]
...
See `the docs <https://txrc.readthedocs.org/en/v0.2.2/>`__ for more information.
...
If you're willing and able, consider `contributing <https://txrc.readthedocs.org/en/v0.2.2/contrib.html>`__.
