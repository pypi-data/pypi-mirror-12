...
.. image:: https://img.shields.io/pypi/v/txrc/0.2.0.svg
...
.. image:: https://readthedocs.org/projects/txrc/badge/?version=v0.2.0
    ...
    :alt: [v0.2.0 Documentation]

.. image:: https://img.shields.io/pypi/l/txrc/0.2.0.svg
    :target: http://opensource.org/licenses/MIT
    :alt: [v0.2.0 License]

.. image:: https://img.shields.io/pypi/pyversions/txrc/0.2.0.svg
    :target: https://pypi.python.org/pypi/txrc/0.2.0
    :alt: [v0.2.0 Supported Python Versions]

.. image:: https://img.shields.io/pypi/implementation/txrc/0.2.0.svg
    :target: https://pypi.python.org/pypi/txrc/0.2.0
    :alt: [v0.2.0 Supported Python Implementations]

.. image:: https://img.shields.io/pypi/status/txrc/0.2.0.svg
    :target: https://pypi.python.org/pypi/txrc/0.2.0
    :alt: [v0.2.0 Development Stage]
