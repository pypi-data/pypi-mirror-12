...
DISTRIBUTION = Distribution('zetup', 'zetup', '0.2.24')

SCRIPTS = {'zest': 'zetup.script:zest', 'zel': 'zetup.script:zel', 'zev': 'zetup.script:zev', 'zake': 'zetup.script:zake', 'zox': 'zetup.script:zox', 'zetup': 'zetup.script:run'}
