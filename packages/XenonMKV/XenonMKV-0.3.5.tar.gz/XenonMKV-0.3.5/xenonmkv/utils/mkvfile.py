...
from xenonmkv.utils.track import MKVTrack, VideoTrack, AudioTrack
...
class MKVFile:
    ...
    def extract_mkv(self):
        ...
        mkvtoolnix_video_id = int(self.tracks[self.video_track_id].mkvtoolnix_id)
        mkvtoolnix_audio_id = int(self.tracks[self.audio_track_id].mkvtoolnix_id)
