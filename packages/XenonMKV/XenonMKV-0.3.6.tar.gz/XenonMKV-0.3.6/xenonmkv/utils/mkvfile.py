...
class MKVFile:
    ...
    def parse_mkvinfo(self, result):
        ...
        try:
            ...
            self.logger.error('Error: mkvfile > parse_mkvinfo')
    ...
    def get_mediainfo(self, track_type):
        ...
        try:
            ...
            self.logger.error('Error: mkvfile > get_mediainfo')
            raise traceback.print_exc()
    ...
    def parse_mediainfo(self, result):
        ...
        try:
            ...
            self.logger.error('Error: mkvfile > parse_mediainfo')
            raise traceback.print_exc()
        return output
    ...
    def select_audio(self, audio_track_list):
        ...
        try:
            ...
            self.logger.error('Error: mkvfile > select_audio')
            raise traceback.print_exc()
    ...
    def select_video(self, video_track_list):
        ...
        try:
            ...
            self.logger.error('Error: mkvfile > select_video')
            raise traceback.print_exc()
    ...
    def extract_mkv(self):
        ...
        if video_track_id > 0 and audio_track_id > 0:
            video_track_id -= 1
            audio_track_id -= 1
