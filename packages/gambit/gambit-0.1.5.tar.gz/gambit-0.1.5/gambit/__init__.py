...
class Msearch(Base):
    ...
    def __init__(self, es, *args, **kwargs):
        """
        :arg es: object of class Elasticsearch from module elasticseach
        :kwarg index: name of the index to be queried (optional)
        :kwarg doc_type: name of documnet type to be queried (optional)
        """
    ...
    def add(self, q, *args, **kwargs):
        ...
        :kwarg index: name of the index to be queried
        :kwarg doc_type: name of documnet type to be queried
        """
