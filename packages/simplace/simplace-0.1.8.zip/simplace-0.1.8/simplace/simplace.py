...
def initSimplace (installDir, workDir, outputDir, additionalClasspathList=[], javaParameters=''):   
    ...
    Args:
        ...
        javaParameters (Optional[str]): Parameters passed to the java virtual machine
...
def stepSimulation(simplaceInstance, count=1, parameters=None, resultFilter=None):
