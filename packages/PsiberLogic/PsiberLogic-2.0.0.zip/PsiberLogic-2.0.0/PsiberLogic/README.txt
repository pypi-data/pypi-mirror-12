Version 2.0.0 has beenreleased which contains major improvements and fixes, any users are
strongly encouraged toupgrade to this new version.

PsiberLogic is a speed-optimized fuzzy control package for Python 3.  Psibernetix is
an active contributor to the open-source movement and is happy to provide this package to
the amazing Python community.

PsiberLogic is a simplified, Cythonized, and compacted package that is a derivative work of Jose
...
errors could be present that will not be reported.  The goal of PsiberLogic is to be working
in the domain of microseconds.
