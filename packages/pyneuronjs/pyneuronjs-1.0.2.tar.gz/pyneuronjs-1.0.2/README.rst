...
`neuron-package-dependency <https://github.com/neuron-js/neuron-package-dependency>`__
...
.. |Build Status| image:: https://travis-ci.org/neuron-js/pyneuron.svg?branch=master
   :target: https://travis-ci.org/neuron-js/pyneuron
