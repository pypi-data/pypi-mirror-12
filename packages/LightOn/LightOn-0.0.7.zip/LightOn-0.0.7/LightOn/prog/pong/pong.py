...
class Attribute:    # Attribute in the gaming sense of the word, rather than of an object
    ...
    def interact (self):    # Bounce from walls or other attributes
        pass
...
class Paddle (Sprite):
    ...
    def predict (self): # Let paddle react on keys
        ...
        Attribute.predict (self)    # Do not yet commit, paddle may bounce with walls
...
class Ball (Sprite):
    ...
    def predict (self):
        Attribute.predict (self)    # Integrate velocity to position
...
class Game:
    def __init__ (self):
        ...
        self.window = pyglet.window.Window (640, 480, visible = False, caption = "Pong")    # Main window
    ...
    def resize (self, width, height):
        ...
        glMatrixMode (GL_PROJECTION)                    # Work with projecten matrix
