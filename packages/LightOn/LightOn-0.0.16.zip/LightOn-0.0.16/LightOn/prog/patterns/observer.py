noUpdate = Exception ('Observer subclass lacks update method')

class Observer:
    def update (self):          # Only here to clarify the interface and
        raise noUpdate          # to give a decent error message
