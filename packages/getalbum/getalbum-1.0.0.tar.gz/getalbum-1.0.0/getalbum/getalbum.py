...
def main():
    ...
    parser.add_argument("album", help="Specify album name")
    parser.add_argument("--artist", help="Specify artist name")
    ...
    if not token:
        ...
        return 1
    for artist, track in get_album_tracklist(args.album, args.artist, token):
