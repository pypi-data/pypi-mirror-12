...
OSS_CREDS_FILENAME = "%s/.alicloudcli/osscredentials" % os.path.expanduser('~')
...
class AliyunCredentials:
    aliyun_access_key_id = "alicloud_access_key_id"
    aliyun_access_key_secret = "alicloud_access_key_secret"

_WRITE_TO_CREDS_FILE = ['alicloud_access_key_id', 'alicloud_access_key_secret']
...
class InteractivePrompter(object):
    ...
    def get_value(self, current_value, config_name, prompt_text=''):
        if config_name in ('alicloud_access_key_id', 'alicloud_access_key_secret'):
...
class ConfigureSetCommand(object):
    ...
    def _writeCredsToFile(self,new_values,profilename):
        ...
        if 'AccessKeyId' in new_values:
            credential_file_values['alicloud_access_key_id'] = new_values.pop(
                'AccessKeyId')
        if 'AccessKeySecret' in new_values:
            credential_file_values['alicloud_access_key_secret'] = new_values.pop(
                'AccessKeySecret')
...
class ConfigureCommand(object):
    ...
    def _writeCredsToFile(self,new_values,profilename):
        credential_file_values = {}
        if 'alicloud_access_key_id' in new_values:
            credential_file_values['alicloud_access_key_id'] = new_values.pop(
                'alicloud_access_key_id')
        if 'alicloud_access_key_secret' in new_values:
            credential_file_values['alicloud_access_key_secret'] = new_values.pop(
    ...
    def _writeCredsToOssFile(self,new_values,profilename = OSS_CONFIG_SECTION):
        credential_file_values = {}
        if 'alicloud_access_key_id' in new_values:
            credential_file_values['accessid'] = new_values['alicloud_access_key_id']
        if 'alicloud_access_key_secret' in new_values:
            credential_file_values['accesskey'] = new_values['alicloud_access_key_secret']
...
class ConfigureGetCommand(object):
    ...
    def _getKeysFromSection(self,profilename,operations):
        if len(operations) >= 2:
            ...
            print 'The correct usage:alicloudcli configure get key --profile profilename'
            return
