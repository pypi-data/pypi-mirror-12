...
# this api will show help page when user input aliyuncli help(-h or --help)
    def showAliyunCliHelp(self):
        print color.bold+"ALICLOUD()"+color.end
        print color.bold+"\nNAME"+color.end
        print "\talicloud -"
        print color.bold+"\nDESCRIPTION"+color.end
        print "\tThe Alicloud Command Line Interface is a unified tool to manage your alicloud services. "
        print color.bold+"\nSYNOPSIS"+color.end
        print "\talicloud <command> <operation> [options and parameters]"
        print "\n\talicloud has supported command completion now. The detail you can check our site."
