ssp_wsdl = '''<?xml version="1.0" encoding="UTF-8" standalone="no"?><wsdl:definitions xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/" xmlns:sch0="http://kezzlerssp.com/schemas/kcengine" xmlns:sch1="http://kezzlerssp.com/schemas/security" xmlns:sch2="http://kezzlerssp.com/schemas/common" xmlns:sch3="http://kezzlerssp.com/schema/metadata/foreign/" xmlns:soap="http://schemas.xmlsoap.org/wsdl/soap/" xmlns:tns="http://kezzlerssp.com/schemas/kcengine" targetNamespace="http://kezzlerssp.com/schemas/kcengine">
  <wsdl:types>
  ...
  <wsdl:service name="kcengineService">
    <wsdl:port binding="tns:kcengineSoap11" name="kcengineSoap11">
      <soap:address location="https://demo.kezzlerssp.com/ssp/kcengine-ws"/>
    </wsdl:port>
  </wsdl:service>
</wsdl:definitions>'''
