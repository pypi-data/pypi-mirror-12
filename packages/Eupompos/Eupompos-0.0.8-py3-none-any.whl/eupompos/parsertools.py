...
class FunctionDeclaration(object):
    ...
    def get_fullname(self):
        """
                FunctionDeclaration.get_fullname()
                ________________________________________________________________

                Return a string representation of the full names of self.
                ________________________________________________________________
    ...
    #///////////////////////////////////////////////////////////////////////////
    def xrepr(self, _with_liaf=True):
        """
        ...
        res = self.get_fullname()

        if _with_liaf:
            res += " in {0}".format(self.liaf)
