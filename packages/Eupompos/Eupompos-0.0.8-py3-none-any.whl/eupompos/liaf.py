...
class LIAF(object):
    """
        ...
        class attribute :
            ...
            o LIAF.max_length_for_filenames : (int) see pos_*() functions.
    ...
    #///////////////////////////////////////////////////////////////////////////
    def pos_and_lines_repr(self, _max_length_for_filenames=max_length_for_filenames):
        """
                ...
                RETURN VALUE    : a string
        """
        return "{0}#{1}\n{2}\"{3}\"".format(LIAF.shorten(self.filename, _max_length_for_filenames),
                                            self.linenumber,
                                            " "*3,
                                            self.line)

    #///////////////////////////////////////////////////////////////////////////
    def pos_repr(self, _max_length_for_filenames=max_length_for_filenames):
        """
                LIAF.pos_repr()
                ________________________________________________________________
                ...
                RETURN VALUE    : a string
        """
        return "{0}#{1}".format(LIAF.shorten(self.filename, _max_length_for_filenames),
                                self.linenumber)

    #///////////////////////////////////////////////////////////////////////////
    @staticmethod
    def shorten(_string, _max_length_for_filenames):
        """
                LIAF.shorten()
                ________________________________________________________________

                Return a shortened version of "string", up to
                _max_length_for_filenames characters.
                ________________________________________________________________
                ...
                RETURN VALUE    : a string
        """
        if len(_string) > _max_length_for_filenames:
            return "(...)" + _string[len(_string) - _max_length_for_filenames:]
        else:
            return _string
