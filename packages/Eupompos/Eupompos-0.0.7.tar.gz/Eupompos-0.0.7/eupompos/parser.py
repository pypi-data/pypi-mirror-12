...
class Parser(object):
    ...
    def __init__(self, _src):
        ...
        if not os.path.exists(source):
            ...
            self.parse_a_file(*os.path.split(source))
    ...
    def filename_ok(_path, _filename):
        """
                ...
                RETURN VALUE : ( (bool)ok, (None/str)language )
    ...
    #///////////////////////////////////////////////////////////////////////////
    def parse_a_file(self, _root, _filename):
        """
                Parser.parse_a_file()
                ________________________________________________________________
                ...
                RETURN VALUE : None
        """
        MSG.debug("Parser.parse_a_file() : {0}, {1}".format(_root, _filename))
        ...
        if tobeparsed:
            with open(os.path.join(_root, _filename), 'r') as src:
                ...
                if language == "cpp":
                    ...
                    self.pyparser.parse(_filename=os.path.join(_root, _filename),
                                        _srccontent=src)
    ...
    def parse_a_path(self, _src):
        ...
        for root, _, files in os.walk(_src):
            for filename in files:
                self.parse_a_file(root, filename)
