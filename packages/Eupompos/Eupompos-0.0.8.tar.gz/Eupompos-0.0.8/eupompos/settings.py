...
$$$ vérifier tout ce merdier $$$
        ...
        o REGEX__PYTHON_CHARS_IN_USEFULLCOM
        o REGEX__PYTHON_SHARPLINE
        o REGEX__CPP_CODE_FILENAMES
        o REGEX__CPP_FUNCTIONDECLARATION
        o REGEX__CPP_CHARS_IN_USEFULLCOM
...
REGEX__PYTHON_CHARS_IN_USEFULLCOM = None
...
REGEX__CPP_CHARS_IN_USEFULLCOM = None
