...
class JpegExifData(object):
    ...
    def __init__(self):
        ...
        self.swaggerTypes = {
            ...
            'Model': 'str',
            'Orientation': 'str',
            'PrimaryChromaticities': 'list[float]',
            'ReferenceBlackWhite': 'list[float]',
            'ResolutionUnit': 'str',
            'Software': 'str',
            'TransferFunction': 'list[int]',
            'XResolution': 'float',
            'YCbCrCoefficients': 'list[float]',
        ...
        self.Artist = None # str
        self.Copyright = None # str
        self.DateTime = None # str
        self.ImageDescription = None # str
        self.Make = None # str
        self.Model = None # str
        self.Orientation = None # str
        self.PrimaryChromaticities = None # list[float]
        self.ReferenceBlackWhite = None # list[float]
        self.ResolutionUnit = None # str
        self.Software = None # str
        self.TransferFunction = None # list[int]
        self.XResolution = None # float
        self.YCbCrCoefficients = None # list[float]
        self.YCbCrPositioning = None # str
