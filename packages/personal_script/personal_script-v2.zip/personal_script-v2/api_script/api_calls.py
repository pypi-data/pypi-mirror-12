...
class ApiFiltered(object):
    ...
    def only_ids(self):
        ...
        non_action_items = ["campaign_group_name", "campaign_group_id", "campaign_name", "campaign_id", "adgroup_name",
                            "adgroup_id"]
        relevance_score = ['score']

        data = JsonParser(export_columns=columns, token=self.token, non_action_list=non_action_items, relevance_score=relevance_score)
