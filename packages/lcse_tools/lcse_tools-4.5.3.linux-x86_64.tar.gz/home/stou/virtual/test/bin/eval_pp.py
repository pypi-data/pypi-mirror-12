#!/home/stou/virtual/science/bin/python
# -*- coding: utf-8 -*-

'''Simple C Pre-Processor evaluation script.'''

__author__ = "Stou Sandalski"
__date__ = '25 Apr 2015'
__copyright__ = "Copyright 2015, Stou Sandalski"
...
def process_file(file_in, file_out, **kwrds):
  ...
  eval_symbols = kwrds.get('symbols')
