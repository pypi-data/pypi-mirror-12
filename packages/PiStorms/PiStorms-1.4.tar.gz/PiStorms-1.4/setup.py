...
setup(name='PiStorms',
    ...
    data_files=[('mindsensors_images', ['btns_center.png', 'btns_left.png', 'btns_right.png', 'button.png', 'dialogbg.png', 'Exclamation-mark-icon.png', 'Pane1.png'])],# ('/etc/init.d', ['PiStormsDriver.sh', 'PiStormsBrowser.sh'])],
