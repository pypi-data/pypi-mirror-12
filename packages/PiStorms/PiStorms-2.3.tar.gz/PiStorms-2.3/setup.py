...
setup(name='PiStorms',
    ...
    ('/home/pi/PiStormsprograms', ['0-About_Me.py', '0-Scratch_PiStorms.py', '1-JesterControl.py', '1-SamTheEmotional.py', '2-CatchMike.py', '2-PyDog.py', '3-custom_i2c_test.py', '4-BatteryBolt.py', '7-SumoEyes.py', '7-touch_sensor.py', '8-GoButton.py', '8-HelloWorld.py', '9-Change_i2c_addr.py', '9-Explorer.py', '9-refresh.py', 'dog.jpg', 'dog.png', 'faceAwesome.png', 'faceClown.png', 'faceClown_eyeLeft', 'faceClown_eyeRight', 'faceClown_nose.png', 'faceHappy.png', 'faceScared2.png', 'Puppy_Dog_Barking.mp3', 'addresschange'])],
