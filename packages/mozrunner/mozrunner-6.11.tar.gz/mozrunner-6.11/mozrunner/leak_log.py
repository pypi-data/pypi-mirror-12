...
def processSingleLeakFile(log, leakLogFileName, processType, leakThreshold,
                          ignoreMissingLeaks):
...
def processLeakLog(log, leak_log_file, leak_thresholds=None,
    ...
    for fileName in os.listdir(leakLogFileDir):
        if fileName.find(leakFileBase) != -1:
            ...
            processSingleLeakFile(log, thisFile, processType, leakThreshold,
